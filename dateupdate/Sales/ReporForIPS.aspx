<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="ReporForIPS.aspx.cs" Inherits="Web.Sales.ReporForIPS" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <%--  <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblUOMNAME11s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtUOMNAME11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtUOMNAME1" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorUOMNAME1" runat="server" ControlToValidate="txtUOMNAME1" ErrorMessage="Uomname1 Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator></div>
                                                                    <asp:Label runat="server" ID="lblUOMNAME12h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtUOMNAME12h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>--%>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-5">
