<%@ Page Title="" Language="C#" MasterPageFile="~/POS/POSMaster.Master" AutoEventWireup="true" CodeBehind="ExpenseList.aspx.cs" Inherits="Web.POS.ExpenseList" %>
                                ...
                                <div class="row">
                                     <div class="col-md-3">
                                        <div class="form-group" style="color: ">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="drpcustomer" runat="server" CssClass="form-control" Visible="false"></asp:DropDownList>
                                 ...
                                 <%--   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Button ID="btnsearch" runat="server" Text="Search" CssClass="btn btn-sm blue" Visible="false" OnClick="btnsearch_Click" />
                                    </div>
                                </div>--%>
                                    ...
                                    <table style="width: 100%" border="1" cellpadding="1" cellspacing="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Refer No</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Category</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Amount</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Note</th>
                                                  <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Posted by</th>
                                            ...
                                            <asp:ListView ID="ListView1" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("Refer No") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("Category") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Amount") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="lblcustomer" runat="server" Text='<%# Eval("Note") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="lblTamount" runat="server" Text='<%# Eval("Posted by") %>'></asp:Label></td>
