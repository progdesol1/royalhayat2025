<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="tblCityStatesCounty.aspx.cs" Inherits="Web.Master.tblCityStatesCounty" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCOUNTRYID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCOUNTRYID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpCOUNTRYID" runat="server" CssClass="form-control select2me input-medium" AutoPostBack="true" OnSelectedIndexChanged="drpCOUNTRYID_SelectedIndexChanged"></asp:DropDownList>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server" ControlToValidate="drpCOUNTRYID" ErrorMessage="COUNTRY Required." CssClass="Validation" ValidationGroup="submit" InitialValue="0"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblStateID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtStateID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpStateID" runat="server" CssClass="form-control select2me input-medium"></asp:DropDownList>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ControlToValidate="drpStateID" ErrorMessage="State Required." CssClass="Validation" ValidationGroup="submit" InitialValue="0"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblStateID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtStateID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCityEnglish1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityEnglish1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtCityEnglish" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorCityEnglish" Display="Dynamic" runat="server" ControlToValidate="txtCityEnglish" ErrorMessage="City English Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblCityEnglish2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityEnglish2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <%--</div>
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCityArabic1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityArabic1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtCityArabic" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorCityArabic" Display="Dynamic" runat="server" ControlToValidate="txtCityArabic" ErrorMessage="City Arabic Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblCityArabic2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityArabic2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCityOther1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityOther1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtCityOther" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorCityOther" Display="Dynamic" runat="server" ControlToValidate="txtCityOther" ErrorMessage="City Other Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblCityOther2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCityOther2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <div class="col-md-6 col-sm-12">
                                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                                        <label>
                                                                                            ...
                                                                                            <asp:LinkButton ID="Linksearch" runat="server" class="btn btn-sm yellow filter-submit margin-bottom" OnClick="Linksearch_Click"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                        </label>
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhStateID" Text="State"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCOUNTRYID" Text="Country"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCityEnglish" Text="City English"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCityArabic" Text="City Arabic"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCityOther" Text="City Other"></asp:Label></th>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblStateID" runat="server" Text='<%# Eval("StateID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCOUNTRYID" runat="server" Text='<%# Eval("COUNTRYID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCityEnglish" runat="server" Text='<%# Eval("CityEnglish")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCityArabic" runat="server" Text='<%# Eval("CityArabic")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCityOther" runat="server" Text='<%# Eval("CityOther")%>'></asp:Label></td>

                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("CityID") +"-"+ Eval("StateID")+"-"+ Eval("COUNTRYID") %>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <%-- <td>
