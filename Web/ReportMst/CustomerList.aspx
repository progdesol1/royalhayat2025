<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="Web.ReportMst.CustomerList" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="color: ">
                                                        ...
                                                        <div class="col-md-1">
                                                            <asp:Button ID="btnAdd" runat="server" class="btn green-haze btn-circle" Text="Search" Style="width: 222px;" OnClick="btnAdd_Click" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <asp:CheckBox ID="ChkAll" runat="server" AutoPostBack="true" OnCheckedChanged="ChkAll_CheckedChanged" ToolTip="Date Range Bypassed" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <asp:CheckBox ID="ChkActive" runat="server" AutoPostBack="true" OnCheckedChanged="ChkActive_CheckedChanged" ToolTip="Date Range Bypassed" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <asp:CheckBox ID="ChkDeactive" runat="server" AutoPostBack="true" OnCheckedChanged="ChkDeactive_CheckedChanged" ToolTip="Date Range Bypassed" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
