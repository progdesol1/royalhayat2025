<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Store_OMReport.aspx.cs" Inherits="Web.ReportMst.Store_OMReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-color: #fff;">
            <table style="width: 100%; height: auto">
                <tr>
                    <td style="width: 99%;">
                        <h2 style="text-align: center;">&nbsp;<asp:Label ID="lblHead" Font-Bold="true" runat="server" Text="Store Opening & Minus Report"></asp:Label>
                        </h2>
                    </td>
                </tr>
            </table>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6" style="padding-left: 36px;">
                                                    <div class="form-group" style="color: ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:DropDownList ID="Dateformate" CssClass="form-control select2me input-small" runat="server" DataTextFormatString="{0:dd/MMM/yyyy}"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
                                                    <div class="caption font-dark">
                                                        ...
                                                        <span class="caption-subject bold uppercase">Store Opening & Minus Report</span>
                                                    </div>
                                                    <div class="tools"></div>
                                                </div>
