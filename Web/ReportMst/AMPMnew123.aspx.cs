...
{
    public partial class AMPMnew123 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (Session["EMPDriver"] != null)
            //{
            //    TID = Convert.ToInt32(((TBLCOMPANYSETUP)Session["EMPDriver"]).TenentID);
            //}
            //else
            //{
            ...
            //}
            if(Request.QueryString["Tenent"] != null)
            {
                TID = Convert.ToInt32(Request.QueryString["Tenent"]);
            }
            if (!IsPostBack)
            {
