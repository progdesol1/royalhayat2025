<%@ Page Title="" Language="C#" MasterPageFile="~/CRM/CRMMaster.Master" AutoEventWireup="true" CodeBehind="CRMMainActivityRole.aspx.cs" Inherits="Web.CRM.CRMMainActivityRole" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCOMPID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCOMPID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="drpCOMPID" runat="server" CssClass="form-control" Visible="true" ></asp:DropDownList>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMasterCODE1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMasterCODE1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="drpMasterCODE" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblMasterCODE2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMasterCODE2h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblRoleID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtRoleID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="drpRoleID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblRoleID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtRoleID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSystemID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSystemID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="drpSystemID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSystemID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSystemID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMenuID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMenuID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="drpMenuID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblMenuID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMenuID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCOMPID" Text="Comp name"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhMasterCODE" Text="Mastercode"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhRoleID" Text="Role name"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhSystemID" Text="System name"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhMenuID" Text="Menu name"></asp:Label></th>
                                                                                                    <th>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="ID" DataKeyNames="ID">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCOMPID" runat="server" Text='<%# Eval("COMPID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblMasterCODE" runat="server" Text='<%# Eval("MasterCODE")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblRoleID" runat="server" Text='<%# Eval("RoleID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblSystemID" runat="server" Text='<%# Eval("SystemID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblMenuID" runat="server" Text='<%# Eval("MenuID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("TenantID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("TenantID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
