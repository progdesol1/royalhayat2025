<%@ Page Title="" Language="C#" MasterPageFile="~/POS/POSMaster.Master" AutoEventWireup="true" CodeBehind="ReportCategory.aspx.cs" Inherits="Web.Admin.ReportCategory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<html><head><title>Caregory_Report</title> <style> @media all {.page-break { display: none; }} @media print { .page-break { display: block; page-break-before: always; }}</style>');
                            ...
                            <div class="portlet light" style="border: 1px solid #abb2c9;">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Caterory</span>
                                    </div>
                                ...
                                <br />
                                <h4>Top 10 Products by Quality</h4>
                                        ...
                                        <tbody>
                                            <asp:ListView ID="ListView1" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblPlan" runat="server" Text='<%# (Eval("Name")) %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("QTY")) %>'></asp:Label></td>

                                                        <%-- <td>
                                                            <asp:Label ID="lblMeal" runat="server" Text='<%# Gettotal(Eval("itemName").ToString()) %>'></asp:Label></td>--%>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:ListView>
                                        </tbody>
                                            ...
                                            <asp:ListView ID="ListView2" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <%--  <td>
                                                            <asp:Label ID="lblMeal" runat="server" Text='<%# Getsum(Eval("itemName").ToString()) %>'></asp:Label></td>--%>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:ListView>
                                        </tbody>
