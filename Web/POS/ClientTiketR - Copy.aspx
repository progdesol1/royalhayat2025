                    ...
                    <div class="todo-sidebar">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <asp:Button ID="btndash" CssClass="btn btn-info" runat="server" Text="Go to Dashboard" OnClick="btndash_Click" /><br /><br />
                                                                ...
                                                                <ItemTemplate>
                                                                    <div class="todo-tasklist-item todo-tasklist-item-border-green" style="border-left: #3faba4 3px solid;">
                                                                        ...
                                                                        <div class="todo-tasklist-item-title">
                                                                            ...
                                                                            <asp:LinkButton ID="btnclick123" class="btn btn-sm blue" Style="margin-left: 50px; padding: 0px 2px 0px 2px; font-weight: bold; height: 20px; width: 52px;" CommandArgument='<%#Eval("MasterCODE")%>' CommandName="btnclick123" runat="server"> &nbsp; Reply &nbsp; </asp:LinkButton>
                                                                            ...
                                                                            <a href='<%# "/POS/ViewTicket.aspx?Mastercode="+ Eval("MasterCODE")%>' class="btn btn-sm blue" style="height: 20px; width: 43px; margin-left: 0px; margin-top: 1px; border-top-width: -15px; padding-top: 0px;" target="_blank">View</a>
                                                ...
                                                <asp:Panel ID="pnlTicki" runat="server">
                                                    <div class="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8" style="margin-bottom: 15px;">
                                                                <asp:TextBox ID="txtMessage" runat="server"  placeholder="Wirte The Messaging" MaxLength="1000" class="form-control todo-taskbody-taskdesc" Rows="4" ></asp:TextBox>
