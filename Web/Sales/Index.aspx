<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Web.Sales.Index" %>
    ...
    <form runat="server" id="form1">
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>This
                                            <asp:Label ID="ThisYearReturn" runat="server" Text="Label"></asp:Label>
                                            Sale Return</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-basket"></i>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <asp:Label ID="lblCo_opsales" runat="server" Text="0"></asp:Label>
                                            </span>
                                            <small class="font-green-sharp">KD</small>
                                        </h3>
                                        <small>This
                                            <asp:Label ID="lblCo_opSalesYear" runat="server" Text="Label"></asp:Label>
                                            Sale of Co-Operative Society</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-basket"></i>
                                    </div>
                                ...
                                <div class="progress-info">
                                    ...
                                    <div class="status">
                                        <div class="status-title">grow </div>
                                        <div class="status-number">
                                            <asp:Label ID="Label8" runat="server" Text="45%"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <asp:Label ID="lblChapra" runat="server" Text="0"></asp:Label>
                                            </span>
                                            <small class="font-green-sharp">KD</small>
                                        </h3>
                                        <small>This
                                            <asp:Label ID="lblChaprayear" runat="server" Text="Label"></asp:Label>
                                            Sale of Chapra</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-basket"></i>
                                    </div>
                                ...
                                <div class="progress-info">
                                    ...
                                    <div class="status">
                                        <div class="status-title">grow </div>
                                        <div class="status-number">
                                            <asp:Label ID="Label9" runat="server" Text="45%"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <asp:Label ID="lblBakala" runat="server" Text="0"></asp:Label>
                                            </span>
                                            <small class="font-green-sharp">KD</small>
                                        </h3>
                                        <small>This
                                            <asp:Label ID="lblbakalayear" runat="server" Text="Label"></asp:Label>
                                            Sale of Bakala</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-basket"></i>
                                    </div>
                                ...
                                <div class="progress-info">
                                    ...
                                    <div class="status">
                                        <div class="status-title">grow </div>
                                        <div class="status-number">
                                            <asp:Label ID="Label10" runat="server" Text="45%"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    ...
                                    <div class="tools">
                                        <asp:Button ID="btnFastCarReport" runat="server" CssClass="btn btn-circle red btn-outline" Text="ALL Report" OnClick="btnFastCarReport_Click" />
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>Today
                                            <asp:Label ID="TodayDatePurchase" runat="server" Text="Label"></asp:Label>
                                            Purchase</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-user"></i>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>This
                                            <asp:Label ID="ThisMonthPurchase" runat="server" Text="Label"></asp:Label>
                                            Purchase</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-user"></i>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>This
                                            <asp:Label ID="ThisYearPurchase" runat="server" Text="Label"></asp:Label>
                                            Purchase</small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-user"></i>
                                            ...
                                            <ol>
                                                <li class="selected" data-date="16/01/2014">
                                                    ...
                                                    <div class="mt-content border-grey-steel">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, mi felis, aliquam at iaculis mi felis, aliquam
                                                            at iaculis finibus eu ex. Integer efficitur tincidunt malesuada. Sed sit amet molestie elit, vel placerat ipsum. Ut consectetur odio non est rhoncus volutpat.
                                                        </p>
                                                ...
                                                <li data-date="28/02/2014">
                                                    ...
                                                    <div class="mt-content border-grey-steel">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, finibus eu ex. Integer efficitur leo eget dolor
                                                ...
                                                <li data-date="20/04/2014">
                                                    ...
                                                    <div class="mt-content border-grey-steel">
                                                        ...
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                                            qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut.
                                                        </p>
                                        ...
                                        <div class="events-content">
                                            <ol>
                                                <li class="selected" data-date="16/01/2014">
                                                    ...
                                                    <div class="mt-content border-grey-steel">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod mi felis, aliquam at iaculis eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis mi felis, aliquam at
                                                            iaculis eu, onsectetur adipiscing elit finibus eu ex. Integer efficitur leo eget dolor tincidunt, et dignissim risus lacinia. Nam in egestas onsectetur adipiscing elit nunc. Suspendisse potenti
                                                        </p>
        ...
        <div class="page-footer">
            <div class="page-footer-inner">
                2016 &copy; digital53 Theme By
                <a target="_blank" href="http://keenthemes.com">Keenthemes</a> &nbsp;|&nbsp;
                <a href="http://themeforest.net/item/digital53-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase digital53 just for 27$ and get lifetime updates for free" target="_blank">Purchase digital53!</a>
            </div>
