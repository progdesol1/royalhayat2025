<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="HPSPrints.aspx.cs" Inherits="Web.Sales.HPSPrints" %>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 20%;">
                                                    <center style="margin-top: 10px;">
                                                        <asp:Label runat="server" ID="lblInvoiceNo" Text="Label"></asp:Label>
                                                   </center>
                                                </td>
