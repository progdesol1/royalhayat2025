...
namespace Web.Sales
{
    public partial class HPSPrints : System.Web.UI.Page
    {
...
//        }
        ...
        public void BindProduct(int TID, int LID, int TRCID)
        {
            ...
            List<TenQtyClass> FList = new List<TenQtyClass>();
            foreach (ICTR_DT item in list)
            {
                TenQtyClass obj = new TenQtyClass();
            ...
            ToWord toWord = new ToWord(Convert.ToDecimal(GalredTotal), currencies[0]);
            ...
            lblInvoiceDate.Text =HDObj.TRANSDATE!=null? HDObj.TRANSDATE.ToString("dd-MMM-yyyy"):"";
            lblInvoiceNo.Text = HDObj.TransDocNo != null ?HDObj.TransDocNo.ToString():"";
        }
