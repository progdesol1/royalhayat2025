...
namespace Web.Sales
{
    public partial class CorpInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["Tranjestion"] != null)
                {
                    ...
                    lblsalemen.Text = DB.tbl_Employee.Single(p => p.TenentID == TID && p.LocationID == LID && p.employeeID == EID).firstname;
                    //
                    ...
                    BindProduct(TRCID);
                    tblsetupsalesh obj = DB.tblsetupsaleshes.Single(p => p.TenentID == TID && p.transid == 4101 && p.transsubid == 410102);
