<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="LocalInvoiceForStaff.aspx.cs" Inherits="Web.Sales.LocalInvoiceForStaff" %>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="" colspan="2">
                                                        ...
                                                        <h3 style="text-align: center;">&nbsp;<asp:Label ID="lblcseandcredt" runat="server" Text="test"></asp:Label>&nbsp; INVOICE FOR STAFF
                                                        </h3>
                                                    ...
                                                    <td style="">
                                                        <strong>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td><span class="muted">Billing Client </span></td>
                                                        ...
                                                        رقم الفاتورة ؛--%>
                                                            <%--<br />
                                                        <span class="muted">Billing Client : </span>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="text-align: center;">
                                                        <%--<h3>&nbsp;About:
                                                            من نحن </h3>--%>
                                                        <asp:Label ID="lblhenderline" Visible="false" runat="server" Text=""></asp:Label>
