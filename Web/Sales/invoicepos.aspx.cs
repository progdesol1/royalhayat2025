...
namespace Web.Sales
{
    public partial class invoicepos : System.Web.UI.Page
    {
        ...
        public void GridData()
        {
            ...
            //List<Database.ICTR_HD> ListDraft = DB.ICTR_HD.Where(p => p.TenentID == TID && (p.Status == "DSO" && p.ACTIVE == true && p.transid == Transid && p.transsubid == Transsubid)).ToList();
        ...
        public void BindDTui(int MYTRANSID)
        {
            ...
            if (List.Count() > 0)
            {
                ...
                decimal QTUtotal = Convert.ToDecimal(List.Sum(p => p.QUANTITY));
            ...
            else
            {
                ...
                decimal QTUtotal = Convert.ToDecimal(listtemp.Sum(p => p.QUANTITY));
                lblqtytotl.Text = QTUtotal.ToString();
        ...
        public void GetShow()
        {
            ...
            lblSupplier1s.Attributes["class"] = lblBatchNo1s.Attributes["class"] = lblTransactionDate1s.Attributes["class"] = lblReference1s.Attributes["class"] = lblTerms1s.Attributes["class"] = "control-label col-md-3  getshow"; //lblNo1s.Attributes["class"] = lblQuantity1s.Attributes["class"] = lblUnitofMeasure1s.Attributes["class"] = ;
            ...
            lblSupplier2h.Attributes["class"] = lblBatchNo2h.Attributes["class"] = lblReference2h.Attributes["class"] = lblTransactionDate2h.Attributes["class"] = lblTerms2h.Attributes["class"] = lblNo2h.Attributes["class"] = "control-label col-md-3 gethide";// lblUnitofMeasure2h.Attributes["class"] =
        ...
        public void GetHide()
        {
            ...
            lblSupplier1s.Attributes["class"] = lblBatchNo1s.Attributes["class"] = lblTransactionDate1s.Attributes["class"] = lblReference1s.Attributes["class"] = lblTerms1s.Attributes["class"] = "control-label col-md-3  gethide";//lblNo1s.Attributes["class"] = lblQuantity1s.Attributes["class"] =lblUnitofMeasure1s.Attributes["class"] =
            ...
            lblSupplier2h.Attributes["class"] = lblBatchNo2h.Attributes["class"] = lblReference2h.Attributes["class"] = lblTransactionDate2h.Attributes["class"] = lblTerms2h.Attributes["class"] = lblNo2h.Attributes["class"] = "control-label col-md-3  getshow";//lblUnitofMeasure2h.Attributes["class"] =
        ...
        protected void btnEditLable_Click(object sender, EventArgs e)
        {
            if (Session["LANGUAGE"].ToString() == "ar-KW")
            {
                ...
                {
                    lblSupplier2h.Visible = lblTransactionDate2h.Visible = lblNo2h.Visible = lblBatchNo2h.Visible = lblReference2h.Visible = lblTerms2h.Visible = lblTotal2h.Visible = lblNotes2h.Visible = lblSupplierName2h.Visible = lblOrderDate2h.Visible = lblTotalAmount2h.Visible = lblStatus2h.Visible = lblEdit12h.Visible = lblAddReference2h.Visible = lblReferenceType2h.Visible = lblReferenceNo2h.Visible = lblSendMail2h.Visible = lblToRecipients2h.Visible = lblCC2h.Visible = false;//lblProduct2h.Visible = lblUnitofMeasure2h.Visible =
                    txtSupplier2h.Visible = txtTransactionDate2h.Visible = txtNo2h.Visible = txtBatchNo2h.Visible = txtReference2h.Visible = txtTerms2h.Visible = txtTotal2h.Visible = txtNotes2h.Visible = txtSupplierName2h.Visible = txtOrderDate2h.Visible = txtTotalAmount2h.Visible = txtStatus2h.Visible = txtEdit12h.Visible = txtAddReference2h.Visible = txtReferenceType2h.Visible = txtReferenceNo2h.Visible = txtSendMail2h.Visible = txtToRecipients2h.Visible = txtCC2h.Visible = true;//txtProduct2h.Visible = txtUnitofMeasure2h.Visible =
                ...
                else
                {
                    ...
                    lblSupplier2h.Visible = lblTransactionDate2h.Visible = lblNo2h.Visible = lblBatchNo2h.Visible = lblReference2h.Visible = lblTerms2h.Visible = lblTotal2h.Visible = lblNotes2h.Visible = lblSupplierName2h.Visible = lblOrderDate2h.Visible = lblTotalAmount2h.Visible = lblStatus2h.Visible = lblEdit12h.Visible = lblAddReference2h.Visible = lblReferenceType2h.Visible = lblReferenceNo2h.Visible = lblSendMail2h.Visible = lblToRecipients2h.Visible = lblCC2h.Visible = true;//lblProduct2h.Visible = lblUnitofMeasure2h.Visible =
                    txtSupplier2h.Visible = txtTransactionDate2h.Visible = txtNo2h.Visible = txtBatchNo2h.Visible = txtReference2h.Visible = txtTerms2h.Visible = txtTotal2h.Visible = txtNotes2h.Visible = txtSupplierName2h.Visible = txtOrderDate2h.Visible = txtTotalAmount2h.Visible = txtStatus2h.Visible = txtEdit12h.Visible = txtAddReference2h.Visible = txtReferenceType2h.Visible = txtReferenceNo2h.Visible = txtSendMail2h.Visible = txtToRecipients2h.Visible = txtCC2h.Visible = false;//txtProduct2h.Visible = txtUnitofMeasure2h.Visible =
                }
            }
            else
            {
                if (btnEditLable.Text == "Update Label")
                {
                    lblSupplier1s.Visible = lblTransactionDate1s.Visible = lblBatchNo1s.Visible = lblReference1s.Visible = lblTerms1s.Visible = lblTotal1s.Visible = lblNotes1s.Visible = lblSupplierName1s.Visible = lblOrderDate1s.Visible = lblTotalAmount1s.Visible = lblStatus1s.Visible = lblEdit11s.Visible = lblAddReference1s.Visible = lblReferenceType1s.Visible = lblReferenceNo1s.Visible = lblSendMail1s.Visible = lblToRecipients1s.Visible = lblCC1s.Visible = false;//lblNo1s.Visible = lblProduct1s.Visible = lblUnitofMeasure1s.Visible = lblQuantity1s.Visible = 
                    txtSupplier1s.Visible = txtTransactionDate1s.Visible = txtBatchNo1s.Visible = txtReference1s.Visible = txtTerms1s.Visible = txtTotal1s.Visible = txtNotes1s.Visible = txtSupplierName1s.Visible = txtOrderDate1s.Visible = txtTotalAmount1s.Visible = txtStatus1s.Visible = txtEdit11s.Visible = txtAddReference1s.Visible = txtReferenceType1s.Visible = txtReferenceNo1s.Visible = txtSendMail1s.Visible = txtToRecipients1s.Visible = txtCC1s.Visible = true;//txtNo1s.Visible = txtProduct1s.Visible = txtUnitofMeasure1s.Visible = txtQuantity1s.Visible = 
                    btnEditLable.Text = "Save Label";
                }
                else
                {
                    ...
                    ManageLang();
                    btnEditLable.Text = "Update Label";
                    lblSupplier1s.Visible = lblTransactionDate1s.Visible = lblBatchNo1s.Visible = lblReference1s.Visible = lblTerms1s.Visible = lblTotal1s.Visible = lblNotes1s.Visible = lblSupplierName1s.Visible = lblOrderDate1s.Visible = lblTotalAmount1s.Visible = lblStatus1s.Visible = lblEdit11s.Visible = lblAddReference1s.Visible = lblReferenceType1s.Visible = lblReferenceNo1s.Visible = lblSendMail1s.Visible = lblToRecipients1s.Visible = lblCC1s.Visible = true;//lblNo1s.Visible = lblProduct1s.Visible = lblUnitofMeasure1s.Visible = lblQuantity1s.Visible =
                    txtSupplier1s.Visible = txtTransactionDate1s.Visible = txtBatchNo1s.Visible = txtReference1s.Visible = txtTerms1s.Visible = txtTotal1s.Visible = txtNotes1s.Visible = txtSupplierName1s.Visible = txtOrderDate1s.Visible = txtTotalAmount1s.Visible = txtStatus1s.Visible = txtEdit11s.Visible = txtAddReference1s.Visible = txtReferenceType1s.Visible = txtReferenceNo1s.Visible = txtSendMail1s.Visible = txtToRecipients1s.Visible = txtCC1s.Visible = false;// txtNo1s.Visible = txtProduct1s.Visible = txtUnitofMeasure1s.Visible = txtQuantity1s.Visible =
                }
            }
        }
        ...
        {
            drpterms.Enabled = rbtPsle.Enabled = false;//ddlProduct.Enabled = ddlUOM.Enabled =
            ...
            BTNsAVEcONFsA.Visible = btnSubmit.Visible = btnConfirmOrder.Visible = btnPrint.Visible = btnSaveData.Visible = btnrefesh.Visible = LinkAccount1.Visible = false; //Custmer.Visible = 
            ...
            btndiscartitems.Enabled = false;// btnAddItemsIn.Enabled = 
        }
        public void WrietMode()
        {
            drpterms.Enabled = rbtPsle.Enabled = true;//ddlProduct.Enabled = ddlUOM.Enabled = 
            ...
            DRPLocationSearch.Enabled = true;
            ...
            btnPrint.Visible = btnSaveData.Visible = btnSubmit.Visible = BTNsAVEcONFsA.Visible = LinkAccount1.Visible = true;//Custmer.Visible = 
            lnkBTNSAVE.Visible = true;
            btnAddDT.Visible = true;
            btnNew.Visible = false;
            btnnewAdd.Visible = false;
            btnrefesh.Visible = true;
            btndiscartitems.Enabled = true;//btnAddItemsIn.Enabled = 
        }
        public void QueryString(int ID)
        {
            ...
            if (DB.ICTR_HD.Where(p => p.MYTRANSID == MYTID && p.TenentID == TID).Count() > 0)
            {
                ...
                DRPLocationSearch.SelectedValue = OBJICTR_HD.CUSTVENDID.ToString();
                drpterms.SelectedValue = OBJICTR_HD.Terms.ToString();
                txtBatchNo.Text = OBJICTR_HD.USERBATCHNO.ToString();
                txtOrderDate.Text = OBJICTR_HD.TRANSDATE.ToString("dd-MMM-yy");
                txtTraNoHD.Text = OBJICTR_HD.MYTRANSID.ToString();
        ...
        public void BindData()
        {
            ...
            DRPLocationSearch.DataSource = DB.TBLCOMPANYSETUPs.Where(p => p.TenentID == TID && p.BUYER == true);
            DRPLocationSearch.DataTextField = "COMPNAME1";
            DRPLocationSearch.DataValueField = "COMPID";
            ...
            if (rbtPsle.SelectedValue == "2")
            {
                ...
                DRPLocationSearch.SelectedValue = COMPID.ToString();
            }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)// dRAFF BUTTON
        {
            if (Session["GetMYTRANSID"] != null)
            {
                ...
                if (listTempDt.Count() <= 0)
                {
                    ...
                    lblMsg123.Text = "Add Atlest One Item In Item List...";
                    return;
                }
                else
                {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
            {
                ...
                if (Session["Invoice"] != null)
                {
                    ...
                    for (int i = 0; i < Repeater2.Items.Count; i++)
                    {
                        ...
                        decimal QUANTITY = Convert.ToDecimal(lblDisQnty.Text); //Convert.ToInt32(lblDisQnty.Text);
                        ...
                        decimal QUANTITYDELIVERD = Convert.ToDecimal(0);
                    ...
                    decimal CUSTVENDID = Convert.ToInt32(DRPLocationSearch.SelectedValue);//Convert.ToInt32(HiddenField3.Value);
                    string LF = "L";
                    ...
                    {
                        Custmerid = DRPLocationSearch.SelectedItem.ToString();//txtLocationSearch.Text;
                        Swit1 = "1";
                    }
                ...
                else
                {
                    ...
                    foreach (Database.ICTR_DT items in ListDate)
                    {
                        ...
                        decimal QUANTITY = Convert.ToDecimal(items.QUANTITY); //Convert.ToInt32(lblDisQnty.Text);
        ...
        protected void ddlProduct_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DateTime TACtionDate = Convert.ToDateTime(txtOrderDate.Text);
            string OICODID = Pidalcode(TACtionDate).ToString();
            if (DRPLocationSearch.SelectedValue == "0" || DRPLocationSearch.SelectedValue == "")
            {
                //pnlSuccessMsg123.Visible = true;
            ...
            else
            {
                ...
                string DIScrip = objprod.ProdName1.ToString();
                FullDicption = DIScrip;
                txtserchProduct.Text = objprod.BarCode;
                FullDicption = FullDicption + "\n " + objprod.Warranty.ToString();
                txtDescription.Text = FullDicption;
                ...
                if (objtblsetupsalesh.AllowMinusQty == false)
                {
                    if (MultiUOM == Convert.ToBoolean(1))
                    {
                        ...
                        //    ListUOm1.Add(objuom);
                        //}
                        var ICIT_BRMUL = DB.ICIT_BR.Where(p => p.TenentID == TID && p.MyProdID == PID && p.LocationID == LID && p.OnHand > 0);
                        if (ICIT_BRMUL.Count() > 0)
                        {
                            foreach (var item in ICIT_BRMUL)
                            {
                                Database.ICUOM objuom = DB.ICUOMs.Single(p => p.TenentID == TID && p.UOM == item.UOM);
                                ListUOm1.Add(objuom);
                            }
                        }
                        else
                        {
                            pnlSuccessMsg123.Visible = true;
                            lblMsg123.Text = "You have No UOM in this item";
                            return;
                        }
                ...
                else
                {
                    ...
                    if (MultiUOM == Convert.ToBoolean(1))
                    {
                        ...
                        ViewState["PID"] = PID;
                        List<Database.ICUOM> ListUOm1 = new List<ICUOM>();
                        List<Database.ICITEMS_PRICE> allMultiUOMPrice = DB.ICITEMS_PRICE.Where(p => p.TenentID == TID && p.MYPRODID == PID).ToList();
                        foreach (Database.ICITEMS_PRICE itemcs in allMultiUOMPrice)
                        {
                            Database.ICUOM listuom123 = DB.ICUOMs.Single(p => p.TenentID == TID && p.UOM == itemcs.UOM);
                            ListUOm1.Add(listuom123);
                        }
                        ddlUOM.DataSource = ListUOm1.Where(p => p.TenentID == TID);
                        ddlUOM.DataTextField = "UOMNAME1";
                        ddlUOM.DataValueField = "UOM";
                ...
                if (Serialized == Convert.ToBoolean(1))
                {
                    ...
                    {
                        decimal TexQty = Convert.ToDecimal(txtQuantity.Text);
                        int UOMSEL = Convert.ToInt32(ddlUOM.SelectedValue);
                        decimal QTY = Convert.ToDecimal(DB.ICIT_BR.Single(p => p.MyProdID == PID && p.TenentID == TID && p.LocationID == LID && p.UOM == UOMSEL).OnHand);
                        ...
                        if (QTY <= TexQty)
                        {
                            decimal avelable = Listserl.Count();
        ...
        protected void btnAddDT_Click(object sender, EventArgs e)
        {
            ...
            {
                pnlSuccessMsg123.Visible = true;
                lblMsg123.Text = "Please Select Item In Item DropList...";
                return;
            }
            if (txtQuantity.Text == "" || txtQuantity.Text == "0" || txtQuantity.Text == "0.0" || txtQuantity.Text == "0.00" || txtQuantity.Text == "0.000")
            {
                pnlSuccessMsg123.Visible = true;
                lblMsg123.Text = "Please Select Valid Quantity...";
                return;
            }
            if (txtUPriceLocal.Text == "" || txtUPriceLocal.Text == "0" || txtUPriceLocal.Text == "0.0" || txtUPriceLocal.Text == "0.00" || txtUPriceLocal.Text == "0.000")
            {
                pnlSuccessMsg123.Visible = true;
                lblMsg123.Text = "Please Select Valid Unit Price...";
                return;
            }
            if (txtTotalCurrencyLocal.Text == "" || txtTotalCurrencyLocal.Text == "0" || txtTotalCurrencyLocal.Text == "0.0" || txtTotalCurrencyLocal.Text == "0.00" || txtTotalCurrencyLocal.Text == "0.000")
            {
                pnlSuccessMsg123.Visible = true;
                lblMsg123.Text = "Please Select Valid Unit Price...";
                return;
            ...
            decimal ENTQTY = Convert.ToDecimal(txtQuantity.Text);
            ...
            if (ICTR_HDCount < 1)
            {
                ...
                objICTR_HD.TOTQTY = Convert.ToDecimal(lblqtytotl.Text); ;
                objICTR_HD.AmtPaid = AmtPaid;
                objICTR_HD.PROJECTNO = PROJECTNO;
                objICTR_HD.CounterID = CounterID;
                objICTR_HD.PrintedCounterInvoiceNo = PrintedCounterInvoiceNo;
            ...
            if (btnAddDT.Text == "Item Save")
            {
                ...
                if (Session["Invoice"] != null)
                {
                    ...
                    lblqtytotl.Text = Convert.ToDecimal(ListTotle.Single(p => p.MYTRANSID == MYTRANSID).TOTQTY).ToString();
                ...
                objICTR_DT.QUANTITY = Convert.ToDecimal(txtQuantity.Text);
                ...
                //btnAddItemsIn.Visible = true;
                btnAddDT.Visible = false;
                decimal QTY1 = Convert.ToDecimal(objICTR_DT.QUANTITY);
            ...
            if (btnAddDT.Text == "Update")
            {
                ...
                decimal TmpQUANTITY = Convert.ToDecimal(objICTR_DT.QUANTITY);
                objICTR_DT.DESCRIPTION = txtDescription.Text;
                objICTR_DT.UOM = ddlUOM.SelectedValue;
                objICTR_DT.QUANTITY = Convert.ToDecimal(txtQuantity.Text);
                LUINTP = Convert.ToDecimal(txtUPriceLocal.Text);
            ...
            objICTR_HD1.TOTQTY = Convert.ToDecimal(lblqtytotl.Text);
        ...
        public void AddNewItem()
        {
            ...
            btnSubmit.Enabled = true; //draft invoice
            btnPrint.Enabled = true; // conferm invoice
            BTNsAVEcONFsA.Enabled = true;//draft invoice
            btnSaveData.Enabled = true;// conferm invoice
            cleardt();
            UpdatePanel3.Update();
        }
        public void cleardt()
        {
            ...
            List<Database.ICIT_BR_Perishable> Listserl = new List<Database.ICIT_BR_Perishable>();
            listperishibal.DataSource = Listserl;
            listperishibal.DataBind();
            List<Database.ICIT_BR_SIZECOLOR> SizeList = new List<Database.ICIT_BR_SIZECOLOR>();
            listSize.DataSource = SizeList;
            listSize.DataBind();
            listmulticoler.DataSource = SizeList;
            listmulticoler.DataBind();
            List<Database.ICIT_BR_BIN> BonList = new List<Database.ICIT_BR_BIN>();
            listBin.DataSource = BonList;
            listBin.DataBind();
            List<Database.ICIT_BR_Serialize> ListSerialize = new List<ICIT_BR_Serialize>();
            listSerial.DataSource = ListSerialize;
            listSerial.DataBind();
        }
        public void BindTempDT(int MYTRANSID, int View)
        {
            decimal TottalSum = 0;
        ...
        protected void grdPO_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                AddNewItem();
                lblmodev.Text = "(Edit Mode)";
                lblmode.Text = "(Edit Mode)";
                lblmodeitem.Text = "(Edit Mode)";
            }
        ...
        protected void Repeater2_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "editDT")
            {
                ...
                {
                    BindDT_ViewAndEdid(str1, str2);
                }
                ViewState["AddnewItems"] = "Yes";
                txtserchProduct.Enabled = false;
                btnserchAdvans.Enabled = true;
                ddlProduct.Enabled = false;
                txtQuantity.Enabled = true;//dipak
                txtUPriceLocal.Enabled = true;//dipak
                txtDiscount.Enabled = true;//dipak
                txtDescription.Enabled = true;//dipak
                panelRed.Visible = true;
            }
            if (e.CommandName == "DTView")
            {
                string[] ID = e.CommandArgument.ToString().Split(',');
                int str1 = Convert.ToInt32(ID[0]);
                int str2 = Convert.ToInt32(ID[1]);
                ...
                btnserchAdvans.Enabled = true;
                ddlProduct.Enabled = false;
                txtQuantity.Enabled = false;//dipak
                txtUPriceLocal.Enabled = false;//dipak
                txtDiscount.Enabled = false;//dipak
                txtDescription.Enabled = false;//dipak
                panelRed.Visible = true;
                penalAddDTITem.Visible = false;
                lnkBTNSAVE.Text = "Item Save";
                btnAddDT.Text = "Item Save";
        ...
        public void BindDT_ViewAndEdid(int mytranceid, int myid)
        {
            int str1 = mytranceid;
            int str2 = myid;
            penalAddDTITem.Visible = true;
            ...
            if (Serialized == Convert.ToBoolean(1))
            {
                ...
                else
                {
                    decimal TexQty = Convert.ToDecimal(txtQuantity.Text);
                    int UOMSEL = Convert.ToInt32(ddlUOM.SelectedValue);
                    decimal QTY = Convert.ToDecimal(0);
                    if (DB.ICIT_BR.Where(p => p.MyProdID == PID && p.TenentID == TID && p.LocationID == LID && p.UOM == UOMSEL).Count() > 0)
                    {
                        QTY = Convert.ToDecimal(DB.ICIT_BR.Single(p => p.MyProdID == PID && p.TenentID == TID && p.LocationID == LID && p.UOM == UOMSEL).OnHand);
                    }
                    List<Database.ICIT_BR_Serialize> ListSerialize = new List<ICIT_BR_Serialize>();
                    ...
                    List<Database.ICIT_BR_TMP> ListSerialTemp = new List<Database.ICIT_BR_TMP>();
                    if (Listserl.Count() == 0)
                    {
                        List<Database.ICIT_BR_TMP> ListSerialTempALLOW = DB.ICIT_BR_TMP.Where(p => p.TenentID == TID && p.MYTRANSID == str1 && p.MyProdID == PID && p.MinusAllow == true).ToList();
                        int Qitem = Convert.ToInt32(TexQty);
                        if (ListSerialTempALLOW.Count() == Qitem)
                        {
                            decimal rqty = 0;
                            foreach (Database.ICIT_BR_TMP items in ListSerialTempALLOW)
                            {
                                ListSerialTemp.Add(items);
                            ...
                            if (Qitem < TexQty)
                            {
                                ...
                                for (int p = 0; p <= rqty - 1; p++)
                                {
                                    Database.ICIT_BR_TMP objseri = new ICIT_BR_TMP();
                                    ListSerialTemp.Add(objseri);
                                }
                            }
                            ViewState["ListofSerlNumber"] = ListSerialTemp;
                            listSerial.DataSource = ListSerialTemp;  //Come from MultiTransaction
                            listSerial.DataBind();
                            for (int z = 0; z < listSerial.Items.Count; z++)
                            {
                                CheckBox cbslectsernumber = (CheckBox)listSerial.Items[z].FindControl("cbslectsernumber");
                                cbslectsernumber.Checked = true;
                            }
                            if (Qitem <= TexQty)
                            {
                                for (int p = 0; p < rqty; p++)
        ...
        {
            int COMPID = Convert.ToInt32(objtblsetupsalesh.DeftCoustomer);
            txtOrderDate.Text = txtBatchNo.Text = txtTraNoHD.Text = SubSerialNo.Text = txtNoteHD.Text = txtrefreshno.Text = txttotxl.Text = "";
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < lidtUom.Items.Count; i++)
            {
                ...
                {
                    decimal TXT = Convert.ToDecimal(txtuomQty.Text);
                    Total = Total + TXT;
                }
            }
            if (QTY == Total)
            {
                ...
                for (int i = 0; i < lidtUom.Items.Count; i++)
                {
                    ...
                    if (txtuomQty.Text != "" && txtuomQty.Text != "0")
                    {
                        ...
                        int TCID = Convert.ToInt32(txtTraNoHD);
                        ...
                        int MYTRANSID = TCID;
                        int LocationID = LID;
                        decimal NewQty = Convert.ToDecimal(txtuomQty.Text);
        ...
        protected void linkMulticoler_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listmulticoler.Items.Count; i++)
            {
                ...
                {
                    decimal TXT = Convert.ToDecimal(txtcoloerqty.Text);
                    Total = Total + TXT;
                }
            }
            if (QTY == Total)
            {
                ...
                for (int i = 0; i < listmulticoler.Items.Count; i++)
                {
                    ...
                    if (txtcoloerqty.Text != "" && txtcoloerqty.Text != "0")
                    {
                        ...
                        int MYTRANSID = TCID;
                        int LocationID = LID;
                        decimal NewQty = Convert.ToDecimal(txtcoloerqty.Text);
        ...
        protected void LinkButton7_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listSize.Items.Count; i++)
            {
                ...
                {
                    decimal TXT = Convert.ToInt32(txtmultisze.Text);
                    Total = Total + TXT;
                }
            }
            if (QTY == Total)
            {
                ...
                for (int i = 0; i < listSize.Items.Count; i++)
                {
                    ...
                    if (txtmultisze.Text != "" && txtmultisze.Text != "0")
                    {
                        ...
                        int MYTRANSID = TCID;
                        int LocationID = LID;
                        decimal NewQty = Convert.ToDecimal(txtmultisze.Text);
        ...
        protected void ddlSupplier_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            int SID = Convert.ToInt32(DRPLocationSearch.SelectedValue); //Convert.ToInt32(HiddenField3.Value);
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            txtDiscount.Enabled = true;//dipak
            txtDescription.Enabled = true;//dipak
            txtserchProduct.Enabled = true;//dipak
            ddlProduct.Enabled = true;//dipak
            txtQuantity.Text = "0";
            txtDescription.Text = "";
            txtQuantity.Text = "0";
            txtDiscount.Text = "0";
            txtUPriceLocal.Text = "0";
            txtTotalCurrencyLocal.Text = "";
            ddlProduct.Items.Clear();
            txtserchProduct.Text = "";

            lblmodev.Text = "(Add Mode)";
            lblmode.Text = "(Add Mode)";
            lblmodeitem.Text = "(Add Mode)";
        ...
        protected void LinkButton10_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listperishibal.Items.Count; i++)
            {
                ...
                {
                    decimal TXT = Convert.ToDecimal(txtnewqty.Text);
                    Total = Total + TXT;
                }
            }
            if (QTY == Total)
            {
                ...
                for (int i = 0; i < listperishibal.Items.Count; i++)
                {
                    ...
                    if (txtnewqty.Text != "" && txtnewqty.Text != "0")
                    {
                        ...
                        int MYTRANSID = TCID;
                        int LocationID = LID;
                        decimal NewQty = Convert.ToDecimal(txtnewqty.Text);
        ...
        protected void lbApproveIss_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listBin.Items.Count; i++)
            {
                ...
                {
                    decimal TXT = Convert.ToDecimal(txtqty.Text);
                    Total = Total + TXT;
                }
            }
            if (QTY == Total)
        ...
        protected void btnallserch_Click(object sender, EventArgs e)
        {
            ...
            string serch = txtallserchforview.Text.ToString().Trim();
            var List = DB.View_HDDT_Advance_search.Where(p => p.TenentID == TID && p.transid == Transid && p.transsubid == Transsubid && (p.Status == "SO" || p.Status == "DSO") && (p.DESCRIPTION.ToUpper().Contains(serch.ToUpper()) || p.ProdName1.ToUpper().Contains(serch.ToUpper()) || p.BarCode.ToUpper().Contains(serch.ToUpper()))).OrderByDescending(p => p.MYTRANSID).ToList();
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
            {
                ...
                if (Session["Invoice"] != null)
                {
                    ...
                    for (int i = 0; i < Repeater2.Items.Count; i++)
                    {
                        ...
                        string DESCRIPTION = lblDiscription.Text;
                        string UOM = lblUOM.Text;
                        decimal QUANTITY = Convert.ToDecimal(lblDisQnty.Text);
                        decimal UNITPRICE = Convert.ToDecimal(lblUNITPRICE.Text);//
                        decimal AMOUNT = Convert.ToDecimal(lblTotalCurrency.Text);//lblTotalCurrency.Text
                        string BATCHNO = "1";
                        int BIN_ID = 1;
                        ...
                        bool flag1 = false;
                        bool multi = Convert.ToBoolean(obj.MultiUOM);
                        decimal QTY = Convert.ToDecimal(QUANTITY);
                        int DT_UOM = Convert.ToInt32(UOM1);
                        if (multi == true)
                        {
                            int BaseUOM = Convert.ToInt32(obj.UOM);
                            bool checkExpRatio = Convert.ToBoolean(DB.ICUOMs.Single(p => p.TenentID == TID && p.UOM == BaseUOM).CalculateAspectRatio);
                            var MultiConvList = DB.ICITEMS_PRICE.Where(p => p.TenentID == TID && p.MYPRODID == MyProdID).ToList();
                            if (checkExpRatio == true)
                            {
                                ...
                                foreach (var MuItem in MultiConvList)
                                {
                                    ...
                                    flag1 = Classes.EcommAdminClass.postprocess(TID, LID, Transid, Transsubid, MYTRANSID, MYID, newQty, Reference, trnsDate, MySysName, MyProdID, ICPOST, UNITPRICE, obj, ToUOM);
                                }
                            }
                            else
                            {
                                flag1 = Classes.EcommAdminClass.postprocess(TID, LID, Transid, Transsubid, MYTRANSID, MYID, QUANTITY, Reference, trnsDate, MySysName, MyProdID, ICPOST, UNITPRICE, obj, DT_UOM);
                            }
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    for (int i = 0; i < Repeater2.Items.Count; i++)
                    {
                        ...
                        //process of multi UOM start HERE
                        bool flag1 = false;
                        bool multi = Convert.ToBoolean(obj.MultiUOM);
                        decimal QTY = Convert.ToDecimal(QUANTITY);
                        int DT_UOM = Convert.ToInt32(UOM1);
                        if (multi == true)
                        {
                            ...
                            if (checkExpRatio == true)
                            {
                                ...
                                foreach (var MuItem in MultiConvList)
                                {
                                    ...
                                    flag1 = Classes.EcommAdminClass.postprocess(TID, LID, Transid, Transsubid, MYTRANSID, MYIDDT, newQty, Reference, trnsDate, MySysName, MyProdID, ICPOST, UNITPRICE, obj, ToUOM);
                                }
                            }
                            else
                            {
                                flag1 = Classes.EcommAdminClass.postprocess(TID, LID, Transid, Transsubid, MYTRANSID, MYIDDT, QUANTITY, Reference, trnsDate, MySysName, MyProdID, ICPOST, UNITPRICE, obj, DT_UOM);
                            }
                        }
                        else
                        {
        ...
        protected void txtQuantity_TextChanged1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (objtblsetupsalesh.AllowMinusQty == false)
                {
                    if (DB.ICIT_BR.Where(p => p.TenentID == TID && p.MyProdID == PID && p.LocationID == LID && p.UOM == uom).Count() > 0)
                    {
                        ...
                        decimal QTY = Convert.ToDecimal(objbr.OnHand);
                        decimal TexQty = Convert.ToDecimal(txtQuantity.Text);
                        if (QTY < TexQty)
                        {
                    ...
                    {
                        string msg = "This Item Is Not In This Unit of measure";
        ...
        {
            decimal LoyqtyGoal = 0;
            var DT = DateTime.Now.Date;
            txtLoyalityDis.Text = "0";
            loymsg.Visible = false;
            int Prodid = Convert.ToInt32(ddlProduct.SelectedValue);
            if (DB.Campaign_MasterProdCat.Where(p => p.TenentID == TID && p.ProductID == Prodid && p.StartDate <= DT && p.EndDate >= DT).Count() > 0)
            {
                Database.Campaign_MasterProdCat Perobj = DB.Campaign_MasterProdCat.Where(p => p.TenentID == TID && p.ProductID == Prodid && p.StartDate <= DT && p.EndDate >= DT).First();
                txtLoyalityDis.Text = Perobj.Petcentage.ToString();
                int campID = Convert.ToInt32(Perobj.CampaignID);
                Database.Campaign_Master Loyobj = DB.Campaign_Master.Single(p => p.TenentID == TID && p.CampaignID == campID);
                LoyqtyGoal = Convert.ToDecimal(Loyobj.ProductGoal);
                loymsg.Visible = true;
                loymsg.Text = "Product Loyality Minimum QTY (" + LoyqtyGoal + ") per Discount";
            }
            string str = "";
            decimal DICUNTOTAL = 0;
            decimal Total = 0;
            ...
            if (txtDiscount.Text.Contains("%"))
            {
                ...
                if (qty >= LoyqtyGoal)
                {
                    LoyDis = Convert.ToDecimal(txtLoyalityDis.Text); //Loyality
                    decimal FinLoy = (DICUNTOTAL * (LoyDis / 100)); //Loyality
                    DICUNTOTAL = DICUNTOTAL - FinLoy;
                }
