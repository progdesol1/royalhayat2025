<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="TBLMaintanance.aspx.cs" Inherits="Web.Master.TBLMaintanance" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorID" runat="server" ControlToValidate="txtID" ErrorMessage=" name Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblQuery1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtQuery1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtQuery" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorQuery" runat="server" ControlToValidate="txtQuery" ErrorMessage="Query Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblQuery2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtQuery2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                      ...
                                                      <%-- <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblDateTime1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtDateTime1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtDateTime" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDateTime" runat="server" ControlToValidate="txtDateTime" ErrorMessage="Datetime Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblDateTime2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtDateTime2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                       </div>--%>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblcbActive1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="cbActive1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:CheckBox ID="cbActive" runat="server" AutoPostBack="true" />

                                                                        <asp:Label runat="server" ID="lblcbActive2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="cbActive2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <%--<div class="row">
                                                                    ...
                                                                    <div class="form-group" style="color: ">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <asp:TextBox ID="txtDeleted" runat="server" CssClass="form-control"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorDeleted" runat="server" ControlToValidate="txtDeleted" ErrorMessage="Deleted Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="color: ">
                                                                        <asp:Label runat="server" ID="lblMODULEID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="drpMODULEID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                        <div class="col-md-8">
                                                                            <asp:DropDownList ID="drpMODULEID" runat="server"></asp:DropDownList>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorMODULEID" runat="server" ControlToValidate="drpMODULEID" ErrorMessage="Module name Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                        </div>
                                                                        <asp:Label runat="server" ID="lblMODULEID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="drpMODULEID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="color: ">
                                                                        <asp:Label runat="server" ID="lblSwichType1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="drpSwichType1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                        <div class="col-md-8">
                                                                            <asp:DropDownList ID="drpSwichType" runat="server">
                                                                                <asp:ListItem Value="1" Select="true">1</asp:ListItem>
                                                                            ...
                                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidatorSwichType" runat="server" ControlToValidate="txtSwichType" ErrorMessage="Swichtype Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>--%>
                                                                        </div>
                                                                        <asp:Label runat="server" ID="lblSwichType2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="drpSwichType2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                                            ...
                                                                                            <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                                <thead>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhID" Text=" name"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhTitle" Text="Title"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhQuery" Text="Query"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhDescription" Text="Description"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhDateTime" Text="Datetime"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhActive" Text="Active"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhDeleted" Text="Deleted"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhMODULEID" Text="Module name"></asp:Label></th>
                                                                                                        <th>
                                                                                                            <asp:Label runat="server" ID="lblhSwichType" Text="Swichtype"></asp:Label></th>
                                                                                                    ...
                                                                                                    <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="ID" DataKeyNames="ID">
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblQuery" runat="server" Text='<%# Eval("Query")%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("Description")%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblDateTime" runat="server" Text='<%# Eval("DateTime")%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblActive" runat="server" Text='<%# Eval("Active")%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblDeleted" runat="server" Text='<%# Eval("Deleted")%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblMODULEID" runat="server" Text='<%#gatdataa(Convert.ToInt32(Eval("MODULEID")))%>'></asp:Label></td>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblSwichType" runat="server" Text='<%# Eval("SwichType")%>'></asp:Label></td>
