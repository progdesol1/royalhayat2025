<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="TBLPROJECT.aspx.cs" Inherits="Web.Master.TBLPROJECT" %>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME11s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPROJECTNAME1" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPROJECTNAME1" runat="server" ControlToValidate="txtPROJECTNAME1" ErrorMessage="Project Name Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME12h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME12h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <%--</div>
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME21s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPROJECTNAME2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPROJECTNAME2" ErrorMessage="Project Name2 Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME22h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME22h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME31s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME31s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPROJECTNAME3" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPROJECTNAME3" ErrorMessage="Project Name3 Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPROJECTNAME32h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTNAME32h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPROJECTDESC1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTDESC1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox TextMode="MultiLine" ID="txtPROJECTDESC" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtPROJECTDESC" ErrorMessage="Project Descreption Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPROJECTDESC2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPROJECTDESC2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <%-- <div class="row">
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhPROJECTNAME1" Text="Projectname1"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhPROJECTNAME2" Text="Projectname2"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhPROJECTNAME3" Text="Projectname3"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhPROJECTDESC" Text="Projectdesc"></asp:Label></th>
                                                                                                    <%--<th>
                                                                                                        <asp:Label runat="server" ID="lblhCRUP_ID" Text="Crup  name"></asp:Label></th>--%>

                                                                                                    <th style="width: 60px;">ACTION</th>
                                                                                                </tr>
                                                                                            </thead>
                                                                                            <tbody>
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="PROJECTNAME1,PROJECTNAME2,PROJECTNAME3,PROJECTDESC" DataKeyNames="PROJECTNAME1,PROJECTNAME2,PROJECTNAME3,PROJECTDESC">
                                                                                                    <LayoutTemplate>
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblPROJECTNAME1" runat="server" Text='<%# Eval("PROJECTNAME1")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblPROJECTNAME2" runat="server" Text='<%# Eval("PROJECTNAME2")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblPROJECTNAME3" runat="server" Text='<%# Eval("PROJECTNAME3")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblPROJECTDESC" runat="server" Text='<%# Eval("PROJECTDESC")%>'></asp:Label></td>
                                                                                                            <%-- <td>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("TenentID")+","+Eval("PROJECTID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("TenentID")+","+Eval("PROJECTID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
