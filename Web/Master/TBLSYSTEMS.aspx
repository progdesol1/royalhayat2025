<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="TBLSYSTEMS.aspx.cs" Inherits="Web.Master.TBLSYSTEMS" %>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSTARTDATE1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSTARTDATE1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorSTARTDATE" runat="server" ControlToValidate="txtSTARTDATE" ErrorMessage="Startdate Required." CssClass="Validation" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("TenantID")+","+ Eval("MYID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("TenantID")+","+ Eval("MYID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
