<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="tblContract_driver.aspx.cs" Inherits="Web.Master.tblContract_driver" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblcontactId1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtcontactId1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpcontactId" runat="server" CssClass="table-group-action-input form-control input-medium" AutoPostBack="true" OnSelectedIndexChanged="drpcontactId_SelectedIndexChanged"></asp:DropDownList>
                                                                    </div>
                                                         ...
                                                         <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <%-- <asp:Label runat="server" ID="lblName1s" class="col-md-4 control-label"></asp:Label>
                                                        ...
                                                        <div class="row">
                                                            <%--<div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblinvoiceid1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtinvoiceid1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpinvoiceid" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblinvoiceid2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtinvoiceid2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>--%>
                                                            <%-- </div>
                                                        <div class="row">--%>
                                                            <%--<div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltripDate1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttripDate1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttripDate" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltripDate2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttripDate2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>--%>
                                                        </div>
                                                        <div class="row">
                                                            <%--  <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltripid1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttripid1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drptripid" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltripid2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttripid2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>--%>
                                                            <%--   </div>
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltimedelivered1s" class="col-md-4 control-label"></asp:Label>
                                                                    <asp:TextBox runat="server" ID="txttimedelivered1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttimedelivered" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txttimedelivered" Format="dd-MMM-yyyy" Enabled="True"></cc1:CalendarExtender>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortimedelivered" runat="server" ControlToValidate="txttimedelivered" ErrorMessage="Timedelivered Required." CssClass="Validation" ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltimedelivered2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttimedelivered2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <%-- <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbldifferentials1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtdifferentials1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:TextBox TextMode="MultiLine" ID="txtdifferentials" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatordifferentials" runat="server" ControlToValidate="txtdifferentials" ErrorMessage="Differentials Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbldifferentials2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtdifferentials2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>--%>
                                                        </div>
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="drpInvoiceID" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList></td>
                                            <td>
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <%-- <th>
                                                                                                        <asp:Label runat="server" ID="lblhlocationid" Text="Locationid"></asp:Label></th>--%>

                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhcontactId" Text="ContactName"></asp:Label></th>
                                                                                                    <%-- <th>
                                                                                                        <asp:Label runat="server" ID="lblhinvoiceid" Text="Invoiceid"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhtripid" Text="Tripid"></asp:Label></th>--%>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhtimedelivered" Text="Timedelivered"></asp:Label></th>
                                                                                                    <%--<th>
                                                                                                        <asp:Label runat="server" ID="lblhdifferentials" Text="Differentials"></asp:Label></th>--%>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="" DataKeyNames="">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <%-- <td>
                                                                                                                <asp:Label ID="lbllocationid" runat="server" Text='<%# Eval("locationid")%>'></asp:Label></td>--%>

                                                                                                            <td>
                                                                                                                <asp:Label ID="lblcontactId" runat="server" Text='<%#getname(Convert.ToInt32(Eval("contactId")))%>'></asp:Label></td>
                                                                                                            <%-- <td>
                                                                                                                <asp:Label ID="lblinvoiceid" runat="server" Text='<%# Eval("invoiceid")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lbltripid" runat="server" Text='<%# Eval("tripid")%>'></asp:Label></td>--%>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lbltimedelivered" runat="server" Text='<%# Eval("timedelivered")%>'></asp:Label></td>
                                                                                                            <%-- <td>
                                                                                                                <asp:Label ID="lbldifferentials" runat="server" Text='<%# Eval("differentials")%>'></asp:Label></td>--%>

                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("contactId")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("contactId")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
