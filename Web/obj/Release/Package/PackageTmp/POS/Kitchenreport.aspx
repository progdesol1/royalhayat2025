<%@ Page Title="" Language="C#" MasterPageFile="~/POS/POSMaster.Master" AutoEventWireup="true" CodeBehind="Kitchenreport.aspx.cs" Inherits="Web.POS.Kitchenreport" %>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Kitchen Report</span>
                                    </div>
                                ...
                                <asp:Panel ID="pnlContents" runat="server">
                                    ...
                                    <table style="width: 100%" border="1" cellpadding="1" cellspacing="1">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">InvoiceNO</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">Date</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">emp_id</th>

                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;">status</th>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("InvoiceNO") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Date") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("emp_id") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
