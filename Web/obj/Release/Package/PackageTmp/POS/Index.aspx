<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/JKMaster.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Web.Admin.Index" %>
        ...
        <div class="page-content">
            ...
            <div class="row margin-top-10" style="margin-bottom: -10px;">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportTodaySale.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <%--<h3 class="font-green-sharp">7800<small class="font-green-sharp">$</small></h3>--%>
                                    <h4 class="font-green-sharp">
                                        <asp:Label ID="Label1" runat="server" Text="Today New Complain "></asp:Label></h4>
                                    <small>7800</small>
                                </div>
                                <div class="icon">
                                    <%--<i class="icon-calendar"></i>--%>
                                    <img src="../Imsges/todaysaleDash.png" style="width: 50px;" />
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportWeeklySale.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-red-haze">
                                        <asp:Label ID="Label2" runat="server" Text="Week Sale"></asp:Label></h4>
                                    <small>1349</small>
                                </div>
                                <div class="icon">
                                    <%-- <i class="icon-like"></i>--%>
                                    <img src="../Imsges/adminIcon_7daysDash.jpg" style="width: 50px;" />
                                </div>
                            </div>
                            <div class="progress-info">
                                <div class="progress">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportMonthySale.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-blue-sharp">
                                        <asp:Label ID="Label3" runat="server" Text="Monthly Sale"></asp:Label></h4>
                                    <small>567</small>
                                </div>
                                <div class="icon">
                                    <%--<i class="icon-basket"></i>--%>
                                    <img src="../Imsges/MothlyDash.png" style="width: 50px;" />
                                </div>
                            </div>
                            <div class="progress-info">
                                <div class="progress">
                            ...
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-purple-soft">
                                        <asp:Label ID="Label4" runat="server" Text="YTD Sale"></asp:Label></h4>
                                    <small>536</small>
                                </div>
                                <div class="icon">
                                    <img src="../Imsges/YTD_definitionDash.jpg" style="width: 50px;" />
                                </div>
                            </div>
                            <div class="progress-info">
                                <div class="progress">
            ...
            <div class="row margin-top-10" style="margin-bottom: -10px;">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportProduct.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-yellow-crusta">
                                        <asp:Label ID="Label5" runat="server" Text="Product"></asp:Label></h4>

                                </div>
                                <div class="icon">
                                    <%--<i class="icon-user"></i>--%>
                                    <img src="../Imsges/Top10Dash.png" style="width: 50px;" />
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportCategory.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-yellow-gold">
                                        <asp:Label ID="Label6" runat="server" Text="Category"></asp:Label></h4>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportCustomer.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-blue-madison">
                                        <asp:Label ID="Label7" runat="server" Text="Customer"></asp:Label></h4>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a href="ReportArea.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-purple-medium">
                                        <asp:Label ID="Label8" runat="server" Text="area"></asp:Label></h4>
            ...
            <div class="row margin-top-10">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportPendingTrans.aspx">
                        <div class="dashboard-stat2">
                            <div class="display">
                                <div class="number">
                                    <h4 class="font-green-meadow">
                                        <asp:Label ID="Label9" runat="server">Pending<br /> Transaction</asp:Label></h4>
                                </div>
                                <div class="icon">
                                    <img src="../Imsges/PendingDash.jpg" style="width: 50px;" />
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    ...
                    <div class="dashboard-stat2">
                        <div class="display">
                            <div class="number">
                                <h4 class="font-blue-steel">
                                    <asp:Label ID="Label10" runat="server" Text="Kitchen"></asp:Label></h4>
                            </div>
                            <div class="icon">
                                <img src="../Imsges/PendingDash.jpg" style="width: 50px;" />
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-right: 0px;">
                    <a href="ReportPendingDelivery.aspx">
                    <div class="dashboard-stat2">
                        <div class="display">
                            <div class="number">
                                <h4 class="font-red-pink">
                                    <asp:Label ID="Label11" runat="server" Text="Delivery"></asp:Label></h4>
                            </div>
                            <div class="icon">
                                <img src="../Imsges/PendingDash.jpg" style="width: 50px;" />
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat2">
                        <div class="display">
                            <div class="number">
                                <h4 class="font-green-seagreen">
                                    <asp:Label ID="Label12" runat="server" Text="Slow Moving"></asp:Label></h4>
                                ...
                                <div id="region_statistics_content" class="display-none">
                                    <div class="btn-toolbar margin-bottom-10">
                                        ...
                                        <div class="btn-group pull-right">
                                            <a href="" class="btn btn-circle grey-salsa btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">Select Region <span class="fa fa-angle-down"></span>
                                            </a>
                                            <ul class="dropdown-menu pull-right">
                                                <li>
