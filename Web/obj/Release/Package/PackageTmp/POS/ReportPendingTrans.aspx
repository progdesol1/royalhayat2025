<%@ Page Title="" Language="C#" MasterPageFile="~/POS/POSMaster.Master" AutoEventWireup="true" CodeBehind="ReportPendingTrans.aspx.cs" Inherits="Web.Admin.ReportPendingTrans" %>
    ...
    <script type="text/javascript">
        function PrintPanel() {
            var panel = document.getElementById("<%=pnlContents.ClientID %>");
                ...
                printWindow.document.write('<html><head><title>Pending_Transaction_Report</title> <style> @media all {.page-break { display: none; }} @media print { .page-break { display: block; page-break-before: always; }}</style>');
                            ...
                            <div class="portlet light" style="border: 1px solid #abb2c9;">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Pending Transation</span>
                                    </div>
                                    ...
                                    <table style="width: 100%" border="1" cellpadding="1" cellspacing="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;"><strong>Customer</strong></th>
                                                <th style="text-align: center; background-color: #FFB6C1; color: #ffffff;"><strong>Order Way </strong></th>
                                            ...
                                            <asp:ListView ID="ListView1" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="lblTamount" runat="server" Text='<%# Eval("Customer") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Order Way") %>'></asp:Label></td>
                                                        <td style="text-align: center;">
