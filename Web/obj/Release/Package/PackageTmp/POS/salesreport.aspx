<%@ Page Title="" Language="C#" MasterPageFile="~/POS/POSMaster.Master" AutoEventWireup="true" CodeBehind="salesreport.aspx.cs" Inherits="Web.POS.salesreport" %>
                                        ...
                                        <tbody>
                                           ...
                                           <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td style="text-align: right; padding-right: 5px;">
                                                    <asp:Label ID="Label13" runat="server" Text="Total Profit:-" Style="font-weight: bold; font-size: large"></asp:Label></td>
                                               <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td style="text-align: center;">
                                                    <asp:Label ID="lblpro" runat="server" Text=""></asp:Label></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right; padding-right: 5px;">
                                                    <asp:Label ID="Label22" runat="server" Text="Sales From  :-" Style="font-weight: bold; font-size: large"></asp:Label></td>
                                                <td style="text-align: center;">
                                            ...
                                            <tr>
                                                <td style="text-align: right; padding-right: 5px;">
                                                    <asp:Label ID="Label14" runat="server" Text="Sales To  :-" Style="font-weight: bold; font-size: large"></asp:Label></td>
                                                <td style="text-align: center;">
