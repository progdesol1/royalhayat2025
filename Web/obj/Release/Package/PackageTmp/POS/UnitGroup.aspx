<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitGroup.aspx.cs" Inherits="Web.POS.UnitGroup" %>
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Unit Group <small>Unit Group</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Unit Group
							</div>
							<div class="tools">
