<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Warehouses.aspx.cs" Inherits="Web.POS.Warehouses" %>
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Warehouse <small>Warehouse</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Warehouse
							</div>
							<div class="tools">
