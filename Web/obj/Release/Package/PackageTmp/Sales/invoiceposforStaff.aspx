<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="invoiceposforStaff.aspx.cs" Inherits="Web.Sales.invoiceposforStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="portlet box green ">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions btn-set">
                                        ...
                                        <asp:LinkButton ID="BtnCheckin" Visible="false" class="btn purple" runat="server">Cash Delivery</asp:LinkButton>
                                        ...
                                        <asp:Button ID="btnEditLable" Visible="false" runat="server" class="btn red" OnClick="btnEditLable_Click" Text="Update Label" />
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6" runat="server" id="Drpdown" visible="true">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="BTnEdit">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLocationSearch" ErrorMessage=" Select Supplier  Required." CssClass="Validation" ValidationGroup="submit1" ForeColor="red"></asp:RequiredFieldValidator>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:Label runat="server" ID="Label32" class="col-md-3 control-label" Text ="Select Receipe"></asp:Label>
                                                                <div class="col-md-8">
                                                                    <asp:DropDownList ID="drpReceipe" CssClass="form-control select2me" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpReceipe_SelectedIndexChanged"></asp:DropDownList>
                                                                </div>                                                                
                                                            </div>
 ...
 <asp:Button ID="Button4" runat="server" class="btn green-haze btn-circle" Text="Cancel" />
                            ...
                            <asp:Label ID="lblSaveCount" runat="server" Text="0 Item Save"></asp:Label>
                                                                            ...
                                                                            <asp:Panel ID="penalAddDTITem" class="portlet-body" runat="server">
                                            ...
                                            <ContentTemplate>--%>
                                                            ...
                                                            <asp:HiddenField ID="hidUOMText" runat="server" Value="" />--%>
                                                                                                        ...
                                                                                                        <asp:Button ID="lnkUomConversion" runat="server" OnClick="lnkUomConversion_Click" Text="UOM Convert" class="btn btn-icon-only purple" Style="width: 100px; padding-top: 4px; padding-bottom: 4px; height: 30px;" />
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                        ...
                                                                                                        <div class="col-md-2">
                                                                                                            <div class="inline-block popovers">
                                                                                                                <%--data-trigger="hover" data-container="body" data-placement="bottom" data-content="Plase Search the product before Save" data-original-title="Popover in bottom"--%>
                                                                                                                <%--<button class="btn btn-default disabled" type="button">Disabled</button>--%>
                                                                                                                <asp:LinkButton ID="lnkBTNSAVE" runat="server" Enabled="false" CssClass="btn btn-icon-only green" ValidationGroup="submititems" OnClick="btnAddDT_Click" Style="width: 80px; padding-top: 4px; padding-bottom: 4px; height: 30px;">Save</asp:LinkButton>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                    ...
                                                                                    <table class="table table-striped table-bordered table-hover" border="1">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th scope="col">
                                                                                                    <asp:Label ID="Label12" runat="server" Text="UOM"></asp:Label>
                                                                                                </th>
                                                                                                <th scope="col">
                                                                    ...
                                                                    <Triggers>
                                                                        ...
                                                                        <%--<asp:AsyncPostBackTrigger ControlID="cbslectsernumber" EventName="CheckedChanged" />--%>
