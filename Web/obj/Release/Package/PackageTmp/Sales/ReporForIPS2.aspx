<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="ReporForIPS2.aspx.cs" Inherits="Web.Sales.ReporForIPS2" %>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnAdd" runat="server" class="btn green-haze btn-circle" OnClick="btnAdd_Click" Text="Sale Report (Today)" Style="width: 222px;" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsReturnHDCT" runat="server" class="btn green-haze btn-circle" Text="Sale Return (Today)" Style="width: 222px;" OnClick="btnsReturnHDCT_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPURHDCT" runat="server" class="btn green-haze btn-circle" Text="Purchase Report (Today)" Style="width: 222px;" OnClick="btnPURHDCT_Click"/>
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPurReportHDCT" runat="server" class="btn green-haze btn-circle" Text="Purchase Return (Today)" Style="width: 222px;" OnClick="btnPurReportHDCT_Click" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnSaleToDT" runat="server" class="btn green-haze btn-circle" Text="Sale Report Detailed (Today)" OnClick="btnSaleToDT_Click" Style="width: 222px;" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsReturnDTCT" runat="server" class="btn green-haze btn-circle" Text="Sale Return Detailed (Today)" Style="width: 222px;" OnClick="btnsReturnDTCT_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPURDTCT" runat="server" class="btn green-haze btn-circle" Text="Purchase Report Detailed (Today)" Style="width: 222px;" OnClick="btnPURDTCT_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPurReportDTCT" runat="server" class="btn green-haze btn-circle" Text="Purchase Return Detailed (Today)" Style="width: 222px;" OnClick="btnPurReportDTCT_Click" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsaleToHDC" runat="server" class="btn green-haze btn-circle" Text="Sale Report" OnClick="btnsaleToHDC_Click" Style="width: 222px;" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsReturnHDC" runat="server" class="btn green-haze btn-circle" Text="Sale Return" Style="width: 222px;"  OnClick="btnsReturnHDC_Click"/>
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPURHDC" runat="server" class="btn green-haze btn-circle" Text="Purchase Report" Style="width: 222px;" OnClick="btnPURHDC_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPurReportHDC" runat="server" class="btn green-haze btn-circle" Text="Purchase Return" Style="width: 222px;" OnClick="btnPurReportHDC_Click"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsaleToDTC" runat="server" class="btn green-haze btn-circle" Text="Sale Report Detailed" OnClick="btnsaleToDTC_Click" Style="width: 222px;" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnsReturnDTC" runat="server" class="btn green-haze btn-circle" Text="Sale Return Detailed" Style="width: 222px;" OnClick="btnsReturnDTC_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPURDTC" runat="server" class="btn green-haze btn-circle" Text="Purchase Report Detailed" Style="width: 222px;" OnClick="btnPURDTC_Click" />
                                                                </div>
                                                                <div class="col-md-3" style="margin-bottom: 10px;">
                                                                    <asp:Button ID="btnPurReportDTC" runat="server" class="btn green-haze btn-circle" Text="Purchase Return Detailed" Style="width: 222px;" OnClick="btnPurReportDTC_Click"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-grey bold uppercase">Report For Daily Sales </span>
                                                </div>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:DropDownList ID="DropDownList1" CssClass="form-horizontal select2me input-xsmall" runat="server">
                                                                        ...
                                                                        <asp:LinkButton ID="lblview" CommandName="view" CommandArgument='<%# Eval("MYTRANSID")%>' runat="server" class="btn btn-sm red fileinput-preview"><i class="fa fa-users"></i></asp:LinkButton></td>
                                                                    </td>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-cogs font-grey"></i>
                                                    <span class="caption-subject font-grey bold uppercase">Report For Daily Sales Details</span>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:DropDownList ID="DropDownList2" CssClass="form-horizontal select2me input-xsmall" runat="server">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-cogs font-grey"></i>
                                                    <span class="caption-subject font-grey-sharp bold uppercase">Report For Purchase</span>
                                                </div>
                                                <div class="tools">
                                                    <a href="javascript:;" class="collapse"></a>
                                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:DropDownList ID="DropDownList3" CssClass="form-horizontal select2me input-xsmall" runat="server">
                                                                            <asp:ListItem Value="1" Text="Detail"></asp:ListItem>
                                                                            <asp:ListItem Value="2" Text="Print"></asp:ListItem>
                                                                            <asp:ListItem Value="3" Text="Trans"></asp:ListItem>
                                                                        </asp:DropDownList>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-cogs font-grey"></i>
                                                    <span class="caption-subject font-grey bold uppercase">Report For Purchase Details</span>
                                                </div>
                                                <div class="tools">
                                                    <a href="javascript:;" class="collapse"></a>
                                                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
