<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales_Master.Master" AutoEventWireup="true" CodeBehind="ServiesHubPrints.aspx.cs" Inherits="Web.Sales.ServiesHubPrints" %>
                                ...
                                <asp:Panel ID="pnlContents" runat="server">
                                    <div>
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="">
                                                    ...
                                                    <center>
                                                    <img src="images/service.jpg" alt="logo" class="logo-default" style="margin-top: 10px; width: 250px;" />
                                                    </center>
                                        ...
                                        <table style="width: 100%; height: auto">
                                            <tbody>
                                                ...
                                                <td style="">
                                                    <table >
                                                        <tr>
                                                            ...
                                                            <td><span class="muted"> / تاريـــخ    : </span> </td>
                                                            <td><asp:Label ID="LblDate" runat="server"></asp:Label>  </td>
                                                        </tr>
                                                        <tr>
                                                            <td><span class="muted"> Invoice  </span> </td>
                                                            <td><span class="muted"> / رقم الفاتورة: </span> </td>
                                                            <td><asp:Label ID="tectionNo" runat="server"></asp:Label></td>                                                            
                                                        </tr>
                                                        <tr>
                                                            <td><span class="muted"> Customer  </span> </td>
                                                            <td><span class="muted">  /  العـمــيـــل:  </span> </td>
                                                            <td><asp:Label ID="labelUSerNAme" runat="server"></asp:Label></td>                                                            
                                                        </tr>
                                                        <tr>
                                                            <td><span class="muted"> Phone  </span> </td>
                                                            <td><span class="muted"> / هــاتــــــف: </span> </td>
                                                            <td> <asp:Label ID="lblPhone" runat="server"></asp:Label></td>                                                            
                                                        </tr>
                                                    </table>
                                                  

                                                  <%--  <span class="muted">Invoice # رقم الفاتورة ؛</span>
                                                    
                                                    
                                                     <br />--%>

                                                  <%--  <span class="muted">Customer العميل ؛ </span>
                                                    
                                                    
                                                     <br />--%>

                                                   <%-- <span class="muted">Phone هاتف ؛ </span>
                                                ...
                                                <td style="text-align: right; width: 320px;">
                                                    ...
                                                    المرجع: 
                                                    <br />--%>
                                                    <span class="muted">62222325:</span><img src="images/phone.png" style="height:20px; width:20px;" />                                                                                 
                                                    <br />
                                                    <span class="muted">SERVICEHUB_KW:</span><img src="images/insta.jpg" style="height:20px; width:20px;"/>                                                                                                    
                                                    <br />
                                                    <span class="muted">SERVICEHUB_KW:</span><img src="images/chat.png" style="height:20px; width:20px;"/>                                                                                                    
                                                    <br />
                                                    <span class="muted">SERVICEHUB.KW@HOTMAIL.COM:</span><img src="images/email.png" style="height:20px; width:20px;"/>                                                                                                   
                                                    <br />
                                                </td>
                                                </tr>
                                               <%-- <tr>
                                                    <td style="width: 30%">
                                                        <h5 style="margin-top: -35px;">Customer : <asp:Label ID="labelUSerNAme" runat="server"></asp:Label>
                                                            العميل</h5>                                                       
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2">
                                                مركز خدمة غسيل السيارات و الشحوم - الشويخ - كندا شارع جاف - اوتوال بلوك - مخزن 142 
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                               Service Hub for Washing & Greasing Cars L.L.C - Shuwaikh - Canada Dry Street - Automall Block - Store 142
                                                </td>
                                           </tr>
                                        </table>
                                        <%--<hr />
