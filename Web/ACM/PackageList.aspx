<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackageList.aspx.cs" Inherits="Web.ACM.PackageList" %>
										...
										<div class="modal-body">
											<div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
												<div class="row">
                                                    ...
                                                    <br />
														<p align ="center">
															<input type="text" class="col-md-12 form-control" placeholder="Set new Password" >
														</p>
														<p align ="center">
															<input type="text" class="col-md-12 form-control" placeholder="Confirm Password" >
														</p>
