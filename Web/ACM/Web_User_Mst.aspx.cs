  ...
  public partial class Web_User_Mst : System.Web.UI.Page
  {
    ...
    public void BindData()
    {
      ...
      else
      {
        ...
        LID = Convert.ToInt32(drpLoctionId.SelectedValue);
    ...
    public void GetShow()
    {
      ...
      lblFIRST_NAME1s.Attributes["class"] = lblLAST_NAME1s.Attributes["class"] = lblFIRST_NAME11s.Attributes["class"] = lblLAST_NAME11s.Attributes["class"] = lblFIRST_NAME21s.Attributes["class"] = lblLAST_NAME21s.Attributes["class"] = lblCOUNTRY1s.Attributes["class"] = lblSTATE1s.Attributes["class"] = lblPH_NO1s.Attributes["class"] = lblFAX_NO1s.Attributes["class"] = lblPINCODE_NO1s.Attributes["class"] = lblPOST_OFFICE1s.Attributes["class"] = lblEMAIL_ADDRESS1s.Attributes["class"] = lblMOBILE_NUM1s.Attributes["class"] = lblSEC_QUES1s.Attributes["class"] = lblSEC_ANS1s.Attributes["class"] = lblLOGIN_ID1s.Attributes["class"] = lblPASSWORD1s.Attributes["class"] = lblUSER_TYPE1s.Attributes["class"] = lblAvtar1s.Attributes["class"] = lblCompId1s.Attributes["class"] = lblTill_DT2h.Attributes["class"] = "control-label col-md-4  getshow";
      lblREMARKS1s.Attributes["class"] = "control-label col-md-2  getshow";
      lblFIRST_NAME2h.Attributes["class"] = lblLAST_NAME2h.Attributes["class"] = lblFIRST_NAME12h.Attributes["class"] = lblLAST_NAME12h.Attributes["class"] = lblFIRST_NAME22h.Attributes["class"] = lblLAST_NAME22h.Attributes["class"] = lblCOUNTRY2h.Attributes["class"] = lblSTATE2h.Attributes["class"] = lblPH_NO2h.Attributes["class"] = lblFAX_NO2h.Attributes["class"] = lblPINCODE_NO2h.Attributes["class"] = lblPOST_OFFICE2h.Attributes["class"] = lblEMAIL_ADDRESS2h.Attributes["class"] = lblMOBILE_NUM2h.Attributes["class"] = lblSEC_QUES2h.Attributes["class"] = lblSEC_ANS2h.Attributes["class"] = lblLOGIN_ID2h.Attributes["class"] = lblPASSWORD2h.Attributes["class"] = lblUSER_TYPE2h.Attributes["class"] = lblAvtar2h.Attributes["class"] = lblCompId2h.Attributes["class"] = lblTill_DT2h.Attributes["class"] = "control-label col-md-4  gethide";
    ...
    public void GetHide()
    {
      lblFIRST_NAME1s.Attributes["class"] = lblLAST_NAME1s.Attributes["class"] = lblFIRST_NAME11s.Attributes["class"] = lblLAST_NAME11s.Attributes["class"] = lblFIRST_NAME21s.Attributes["class"] = lblLAST_NAME21s.Attributes["class"] = lblCOUNTRY1s.Attributes["class"] = lblSTATE1s.Attributes["class"] = lblPH_NO1s.Attributes["class"] = lblFAX_NO1s.Attributes["class"] = lblPINCODE_NO1s.Attributes["class"] = lblPOST_OFFICE1s.Attributes["class"] = lblEMAIL_ADDRESS1s.Attributes["class"] = lblMOBILE_NUM1s.Attributes["class"] = lblSEC_QUES1s.Attributes["class"] = lblSEC_ANS1s.Attributes["class"] = lblLOGIN_ID1s.Attributes["class"] = lblPASSWORD1s.Attributes["class"] = lblUSER_TYPE1s.Attributes["class"] = lblAvtar1s.Attributes["class"] = lblCompId1s.Attributes["class"] = lblTill_DT1s.Attributes["class"] = "control-label col-md-4  gethide";
      lblREMARKS1s.Attributes["class"] = "control-label col-md-2  gethide";
      lblFIRST_NAME2h.Attributes["class"] = lblLAST_NAME2h.Attributes["class"] = lblFIRST_NAME12h.Attributes["class"] = lblLAST_NAME12h.Attributes["class"] = lblFIRST_NAME22h.Attributes["class"] = lblLAST_NAME22h.Attributes["class"] = lblCOUNTRY2h.Attributes["class"] = lblSTATE2h.Attributes["class"] = lblPH_NO2h.Attributes["class"] = lblFAX_NO2h.Attributes["class"] = lblPINCODE_NO2h.Attributes["class"] = lblPOST_OFFICE2h.Attributes["class"] = lblEMAIL_ADDRESS2h.Attributes["class"] = lblMOBILE_NUM2h.Attributes["class"] = lblSEC_QUES2h.Attributes["class"] = lblSEC_ANS2h.Attributes["class"] = lblLOGIN_ID2h.Attributes["class"] = lblPASSWORD2h.Attributes["class"] = lblUSER_TYPE2h.Attributes["class"] = lblAvtar2h.Attributes["class"] = lblCompId2h.Attributes["class"] = lblTill_DT1s.Attributes["class"] = "control-label col-md-4  getshow";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
      using (TransactionScope scope = new TransactionScope())
      {
        ...
        if (btnAdd.Text == "AddNew")
        {
          ...
          Write();
          Clear();
          btnAdd.ValidationGroup = "usergroup";
          btnAdd.Text = "Add";
        ...
        else if (btnAdd.Text == "Add")
        {
          ...
          if (Request.QueryString["TID"] != null)
          {
            objUSER_DTL.TenentID = Convert.ToInt32(Request.QueryString["TID"]);
          }
          else
          {
            objUSER_DTL.TenentID = Convert.ToInt32(drpTenentID.SelectedValue);
          }
          ...
          if (drpLoctionId.SelectedValue != "0")
          {
            objUSER_DTL.LOCATION_ID = Convert.ToInt32(drpLoctionId.SelectedValue);
          }
          ...
          //if (Convert.ToInt32(drpTenentID.SelectedValue) != 0)
          //{
          //    objUSER_MST.TenentID = Convert.ToInt32(drpTenentID.SelectedValue);
          //}
          //objUSER_MST.USER_ID = DB.USER_MST.Count() > 0 ? Convert.ToInt32(DB.USER_MST.Max(p => p.USER_ID) + 1) : 1;
          //if (Convert.ToInt32(drpLoctionId.SelectedValue) != 0)
          //{
          //    objUSER_MST.LOCATION_ID = Convert.ToInt32(drpLoctionId.SelectedValue);
          //}
          //objUSER_MST.FIRST_NAME = txtFIRST_NAME.Text;
          //objUSER_MST.LAST_NAME = txtLAST_NAME.Text;
          //objUSER_MST.FIRST_NAME1 = txtFIRST_NAME1.Text;
          //objUSER_MST.LAST_NAME1 = txtLAST_NAME1.Text;
          //objUSER_MST.FIRST_NAME2 = txtFIRST_NAME2.Text;
          //objUSER_MST.LAST_NAME2 = txtLAST_NAME2.Text;
          //objUSER_MST.LOGIN_ID = txtLOGIN_ID.Text;
          //objUSER_MST.PASSWORD = Classes.GlobleClass.EncryptionHelpers.Encrypt(txtPASSWORD.Text);
          //objUSER_MST.PASSWORD_CHNG =  txtPASSWORD.Text;
          //if (Convert.ToInt32(drpUSER_TYPE.SelectedValue) != 0)
          //{
          //    objUSER_MST.USER_TYPE = Convert.ToInt32(drpUSER_TYPE.SelectedValue);
          //}

          //objUSER_MST.REMARKS = txtREMARKS.Text;
          //objUSER_MST.ACTIVE_FLAG = "Y";
          //objUSER_MST.LAST_LOGIN_DT = DateTime.Now;
          //objUSER_MST.ACC_LOCK = "Y";
          //objUSER_MST.FIRST_TIME = "Y";
          //objUSER_MST.EmailAddress = txtEMAIL_ADDRESS.Text;
          //objUSER_MST.Avtar = txtAvtar.Text;
          //objUSER_MST.Till_DT = Convert.ToDateTime(txtTill_DT.Text);
          //if (drpCompId.SelectedValue != "0")
          //{
          //    objUSER_MST.CompId = Convert.ToInt32(drpCompId.SelectedValue);
          //}
          //objUSER_MST.USER_DETAIL_ID = objUSER_DTL.USER_DETAIL_ID;
          //objUSER_MST.ACTIVEUSER = CHKActiveUser.Checked == true ? true : false;
          //objUSER_MST.USERDATE = Convert.ToDateTime(txtuserdate.Text);
          ...
          string PH_NO = txtPH_NO.Text;
          string FAX_NO = txtFAX_NO.Text;
          string PINCODE_NO = txtPINCODE_NO.Text;
          string POST_OFFICE = txtPOST_OFFICE.Text;
          string EMAIL_ADDRESS = txtEMAIL_ADDRESS.Text;
          Int64 MOBILE_NUM = Convert.ToInt64(txtMOBILE_NUM.Text);
          string SEC_QUES = drpSEC_QUES.SelectedValue;
          string SEC_ANS = txtSEC_ANS.Text;
          int LOCATION_ID = Convert.ToInt32(drpLoctionId.SelectedValue);
          objUSER_DTL.USER_DETAIL_ID = DB.USER_DTL.Count() > 0 ? Convert.ToInt32(DB.USER_DTL.Max(p => p.USER_DETAIL_ID) + 1) : 1;
          ...
          if (Request.QueryString["TID"] != null)
          {
            UserTenent = Convert.ToInt32(Request.QueryString["TID"]);
          }
          else
          {
            UserTenent = Convert.ToInt32(drpTenentID.SelectedValue);
            Locationid = Convert.ToInt32(drpLoctionId.SelectedValue);
          }
          ...
          DateTime USERDATE = Convert.ToDateTime(txtTill_DT.Text);
          ...
          ////////////////////////////////////////////////////////////
          int selectedUser = 0;
          if (!string.IsNullOrEmpty(drpusers.SelectedValue))
            selectedUser = Convert.ToInt32(drpusers.SelectedValue);

          bool isInserted = false;
          string connectionString = ConfigurationManager.ConnectionStrings["CRMNewEntitiesNew"].ConnectionString;

          using (SqlConnection conn = new SqlConnection(connectionString))
          using (SqlCommand cmd = new SqlCommand("Register_User", conn))
          {
            cmd.CommandType = CommandType.StoredProcedure;

            // USER_MST params
            cmd.Parameters.Add("@UserTenent", SqlDbType.Int).Value = UserTenent;
            cmd.Parameters.Add("@Userid", SqlDbType.Int).Value = Userid;
            cmd.Parameters.Add("@Locationid", SqlDbType.Int).Value = Locationid;
            cmd.Parameters.Add("@FIRST_NAME", SqlDbType.NVarChar, 100).Value = FIRST_NAME ?? (object)DBNull.Value;
            cmd.Parameters.Add("@LAST_NAME", SqlDbType.NVarChar, 100).Value = LAST_NAME ?? (object)DBNull.Value;
            cmd.Parameters.Add("@FIRST_NAME1", SqlDbType.NVarChar, 100).Value = FIRST_NAME1 ?? (object)DBNull.Value;
            cmd.Parameters.Add("@LAST_NAME1", SqlDbType.NVarChar, 100).Value = LAST_NAME1 ?? (object)DBNull.Value;
            cmd.Parameters.Add("@FIRST_NAME2", SqlDbType.NVarChar, 100).Value = FIRST_NAME2 ?? (object)DBNull.Value;
            cmd.Parameters.Add("@LAST_NAME2", SqlDbType.NVarChar, 100).Value = LAST_NAME2 ?? (object)DBNull.Value;
            cmd.Parameters.Add("@LOGIN_ID", SqlDbType.NVarChar, 50).Value = LOGIN_ID ?? (object)DBNull.Value;
            cmd.Parameters.Add("@PASSWORD", SqlDbType.NVarChar, 200).Value = PASSWORD ?? (object)DBNull.Value;
            cmd.Parameters.Add("@PASSWORD_CHNG", SqlDbType.NVarChar, 1).Value = PASSWORD_CHNG ?? (object)DBNull.Value;
            cmd.Parameters.Add("@USER_TYPE", SqlDbType.Int).Value = USER_TYPE;
            cmd.Parameters.Add("@REMARKS", SqlDbType.NVarChar, 500).Value = REMARKS ?? (object)DBNull.Value;
            cmd.Parameters.Add("@ACTIVE_FLAG", SqlDbType.NVarChar, 1).Value = ACTIVE_FLAG ?? (object)DBNull.Value;
            cmd.Parameters.Add("@LAST_LOGIN_DT", SqlDbType.DateTime).Value = LAST_LOGIN_DT;
            cmd.Parameters.Add("@ACC_LOCK", SqlDbType.NVarChar, 1).Value = ACC_LOCK ?? (object)DBNull.Value;
            cmd.Parameters.Add("@FIRST_TIME", SqlDbType.NVarChar, 1).Value = FIRST_TIME ?? (object)DBNull.Value;
            cmd.Parameters.Add("@EmailAddress", SqlDbType.NVarChar, 200).Value = EmailAddress ?? (object)DBNull.Value;
            cmd.Parameters.Add("@Avtar", SqlDbType.NVarChar, 200).Value = Avtar ?? (object)DBNull.Value;
            cmd.Parameters.Add("@Till_DT", SqlDbType.Date).Value = Till_DT;
            cmd.Parameters.Add("@CompId", SqlDbType.Int).Value = CompId;
            cmd.Parameters.Add("@USER_DETAIL_ID", SqlDbType.Int).Value = USER_DETAIL_ID;
            cmd.Parameters.Add("@ACTIVEUSER", SqlDbType.Bit).Value = ACTIVEUSER;
            cmd.Parameters.Add("@USERDATE", SqlDbType.DateTime).Value = USERDATE;
            cmd.Parameters.Add("@Flage", SqlDbType.NVarChar, 10).Value = Flage ?? (object)DBNull.Value;
            cmd.Parameters.Add("@Lang1", SqlDbType.NVarChar, 10).Value = Lang1 ?? (object)DBNull.Value;
            

            // USER_DTL params
            cmd.Parameters.Add("@COUNTRY", SqlDbType.Int).Value = COUNTRY;
            cmd.Parameters.Add("@STATE", SqlDbType.NVarChar, 50).Value = STATE ?? (object)DBNull.Value;
            cmd.Parameters.Add("@PH_NO", SqlDbType.NVarChar, 20).Value = PH_NO ?? (object)DBNull.Value;
            cmd.Parameters.Add("@FAX_NO", SqlDbType.NVarChar, 20).Value = FAX_NO ?? (object)DBNull.Value;
            cmd.Parameters.Add("@PINCODE_NO", SqlDbType.NVarChar, 20).Value = PINCODE_NO ?? (object)DBNull.Value;
            cmd.Parameters.Add("@POST_OFFICE", SqlDbType.NVarChar, 100).Value = POST_OFFICE ?? (object)DBNull.Value;
            cmd.Parameters.Add("@MOBILE_NUM", SqlDbType.BigInt).Value = MOBILE_NUM;
            cmd.Parameters.Add("@SEC_QUES", SqlDbType.NVarChar, 200).Value = SEC_QUES ?? (object)DBNull.Value;
            cmd.Parameters.Add("@SEC_ANS", SqlDbType.NVarChar, 200).Value = SEC_ANS ?? (object)DBNull.Value;

            // Privilege copy
            cmd.Parameters.Add("@FromUserID", SqlDbType.Int).Value = selectedUser;
            cmd.Parameters.Add("@ActiveTillDate", SqlDbType.Date).Value = Convert.ToDateTime(txtTill_DT.Text);
            ...
            {
              throw new ApplicationException("SQL Error in RegisterUser: " + sqlEx.Message, sqlEx);
            }
            catch (Exception ex)
            {
              throw new ApplicationException("Error in RegisterUser: " + ex.Message, ex);
            }
        ...
        else if (btnAdd.Text == "Update")
        {
          ...
          if (ViewState["Edit"] != null)
          {
            ...
            if (Request.QueryString["TID"] != null)
            {
              TenentID = Convert.ToInt32(Request.QueryString["TID"]);
            }
            else
            {
              TenentID = Convert.ToInt32(drpTenentID.SelectedValue);
              LOCATION_ID = Convert.ToInt32(drpLoctionId.SelectedValue);
            }
            ...
            /*if (DB.USER_MST.Where(p => p.USER_ID == ID && p.TenentID == TenentID).Count() > 0)
            {
              ...
              Database.USER_DTL objUSER_DTL = DB.USER_DTL.Single(p => p.USER_DETAIL_ID == USERDIID && p.TenentID == TenentID);
            ...
            //Database.USER_MST objUSER_MST = DB.USER_MST.Single(p => p.USER_ID == ID);
            //if (Convert.ToInt32(drpTenentID.SelectedValue) != 0)
            //{
            //    objUSER_MST.TenentID = Convert.ToInt32(drpTenentID.SelectedValue);
            //}
            ...
            string LAST_NAME2 = txtLAST_NAME2.Text;
            string LOGIN_ID = txtLOGIN_ID.Text;
            string PASSWORD = objUSER_MST.PASSWORD;//Classes.GlobleClass.EncryptionHelpers.Encrypt(txtPASSWORD.Text);
            ...
            string Lang1 = DrpDefaulrLang.SelectedValue;
            string Flage = "EDIT";
            /*Classes.ACMClass.InsertWeb_User_MST(TenentID, UserID, LOCATION_ID, FIRST_NAME, LAST_NAME, FIRST_NAME1, LAST_NAME1, FIRST_NAME2, LAST_NAME2, LOGIN_ID, PASSWORD, PASSWORD_CHNG, USER_TYPE, REMARKS, ACTIVE_FLAG, LAST_LOGIN_DT, ACC_LOCK, FIRST_TIME, EmailAddress, Avtar, Till_DT, CompId, USER_DETAIL_ID, ACTIVEUSER, USERDATE, Flage, Lang1);*/
            /////////////////////////////////////////////////////////
            int selectedUser = 0;
            if (!string.IsNullOrEmpty(drpusers.SelectedValue))
              selectedUser = Convert.ToInt32(drpusers.SelectedValue);
            ...
            using (SqlCommand cmd = new SqlCommand("Register_User", conn))
            {
              ...
              // USER_MST params
              cmd.Parameters.Add("@UserTenent", SqlDbType.Int).Value = UserTenent;
              cmd.Parameters.Add("@Userid", SqlDbType.Int).Value = USER_DETAIL_ID;
              cmd.Parameters.Add("@Locationid", SqlDbType.Int).Value = Locationid;
              cmd.Parameters.Add("@FIRST_NAME", SqlDbType.NVarChar, 100).Value = FIRST_NAME ?? (object)DBNull.Value;
              cmd.Parameters.Add("@LAST_NAME", SqlDbType.NVarChar, 100).Value = LAST_NAME ?? (object)DBNull.Value;
              cmd.Parameters.Add("@FIRST_NAME1", SqlDbType.NVarChar, 100).Value = FIRST_NAME1 ?? (object)DBNull.Value;
    ...
    public void TenentBind()
    {
      ...
      //                  }
      //).Distinct();
      List<Database.TBLLOCATION> Tlist = DB.TBLLOCATIONs.Where(p => p.TenentID == TID).GroupBy(p => p.TenentID).Select(p => p.FirstOrDefault()).ToList();
      drpTenentID.DataSource = Tlist; //Datas;
    ...
    public void FillContractorID()
    {
      ...
      //Classes.EcommAdminClass.getdropdown(drpCompId, TID, "", "", "", "TBLCOMPANYSETUP");
      //select * from TBLCOMPANYSETUP where TenantID=1 and PHYSICALLOCID ='HLY'

      drpCompId.DataSource = DB.TBLCOMPANYSETUPs.Where(p => p.Active == "Y" && p.TenentID == TID).OrderBy(m => m.COMPNAME1).Take(100);//Classes.EcommAdminClass.getDataTBLCOMPANYSETUP(TID).OrderBy(p => p.COMPNAME1);
      drpCompId.DataTextField = "COMPNAME1";
      drpCompId.DataValueField = "COMPID";
      drpCompId.DataBind();
      drpCompId.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Company--", "0"));
      drpusers.DataSource = DB.USER_MST.Where(p => p.TenentID == TID && p.ACTIVEUSER == true && p.THEME_NAME == "YES").OrderBy(p => p.FIRST_NAME);
      drpusers.DataTextField = "FIRST_NAME";
      drpusers.DataValueField = "USER_ID";
      drpusers.DataBind();
      drpusers.Items.Insert(0, new ListItem("-- Select User--", "0"));
      Classes.EcommAdminClass.getdropdown(drpSEC_QUES, 1, "", "", "", "ERP_QUESTION_BANK");
      //select * from ERP_QUESTION_BANK where ACTIVE_FLAG ='Y'

      //drpSEC_QUES.DataSource = DB.ERP_QUESTION_BANK.Where(p => p.ACTIVE_FLAG == "Y");
      //drpSEC_QUES.DataTextField = "QUESTION";
      //drpSEC_QUES.DataValueField = "QUESTION_ID";
      //drpSEC_QUES.DataBind();
      //drpSEC_QUES.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select QUESTION--", "0"));
      ...
      DrpDefaulrLang.DataSource = DB.tblLanguages.Where(p => p.TenentID == 0);
      ...
      //drpCOUNTRY.DataBind();
      //drpCOUNTRY.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select COUNTRY--", "0"));
      if (Request.QueryString["TID"] != null)
      {
      ...
      drpLoctionId.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Loction--", "0"));
    ...
    protected void btnEditLable_Click(object sender, EventArgs e)
    {
      if (Session["LANGUAGE"].ToString() == "ar-KW")
      {
        if (btnEditLable.Text == "Update Label")
        {
          ...
          //2false
          lblFIRST_NAME2h.Visible = lblLAST_NAME2h.Visible = lblFIRST_NAME12h.Visible = lblLAST_NAME12h.Visible = lblFIRST_NAME22h.Visible = lblLAST_NAME22h.Visible = lblCOUNTRY2h.Visible = lblSTATE2h.Visible = lblPH_NO2h.Visible = lblFAX_NO2h.Visible = lblPINCODE_NO2h.Visible = lblPOST_OFFICE2h.Visible = lblEMAIL_ADDRESS2h.Visible = lblMOBILE_NUM2h.Visible = lblSEC_QUES2h.Visible = lblSEC_ANS2h.Visible = lblLOGIN_ID2h.Visible = lblPASSWORD2h.Visible = lblUSER_TYPE2h.Visible = lblREMARKS2h.Visible = lblAvtar2h.Visible = lblCompId2h.Visible = lblTill_DT2h.Visible = false;
          //2true
          txtFIRST_NAME2h.Visible = txtLAST_NAME2h.Visible = txtFIRST_NAME12h.Visible = txtLAST_NAME12h.Visible = txtFIRST_NAME22h.Visible = txtLAST_NAME22h.Visible = txtCOUNTRY2h.Visible = txtSTATE2h.Visible = txtPH_NO2h.Visible = txtFAX_NO2h.Visible = txtPINCODE_NO2h.Visible = txtPOST_OFFICE2h.Visible = txtEMAIL_ADDRESS2h.Visible = txtMOBILE_NUM2h.Visible = txtSEC_QUES2h.Visible = txtSEC_ANS2h.Visible = txtLOGIN_ID2h.Visible = txtPASSWORD2h.Visible = txtUSER_TYPE2h.Visible = txtREMARKS2h.Visible = txtAvtar2h.Visible = txtCompId2h.Visible = txtTill_DT2h.Visible = true;
        ...
        else
        {
          ...
          //2true
          lblFIRST_NAME2h.Visible = lblLAST_NAME2h.Visible = lblFIRST_NAME12h.Visible = lblLAST_NAME12h.Visible = lblFIRST_NAME22h.Visible = lblLAST_NAME22h.Visible = lblCOUNTRY2h.Visible = lblSTATE2h.Visible = lblPH_NO2h.Visible = lblFAX_NO2h.Visible = lblPINCODE_NO2h.Visible = lblPOST_OFFICE2h.Visible = lblEMAIL_ADDRESS2h.Visible = lblMOBILE_NUM2h.Visible = lblSEC_QUES2h.Visible = lblSEC_ANS2h.Visible = lblLOGIN_ID2h.Visible = lblPASSWORD2h.Visible = lblUSER_TYPE2h.Visible = lblREMARKS2h.Visible = lblAvtar2h.Visible = lblCompId2h.Visible = lblTill_DT2h.Visible = true;
          //2false
          txtFIRST_NAME2h.Visible = txtLAST_NAME2h.Visible = txtFIRST_NAME12h.Visible = txtLAST_NAME12h.Visible = txtFIRST_NAME22h.Visible = txtLAST_NAME22h.Visible = txtCOUNTRY2h.Visible = txtSTATE2h.Visible = txtPH_NO2h.Visible = txtFAX_NO2h.Visible = txtPINCODE_NO2h.Visible = txtPOST_OFFICE2h.Visible = txtEMAIL_ADDRESS2h.Visible = txtMOBILE_NUM2h.Visible = txtSEC_QUES2h.Visible = txtSEC_ANS2h.Visible = txtLOGIN_ID2h.Visible = txtPASSWORD2h.Visible = txtUSER_TYPE2h.Visible = txtREMARKS2h.Visible = txtAvtar2h.Visible = txtCompId2h.Visible = txtTill_DT2h.Visible = false;
      ...
      else
      {
        ...
        {
          //1false
          lblFIRST_NAME1s.Visible = lblLAST_NAME1s.Visible = lblFIRST_NAME11s.Visible = lblLAST_NAME11s.Visible = lblFIRST_NAME21s.Visible = lblLAST_NAME21s.Visible = lblCOUNTRY1s.Visible = lblSTATE1s.Visible = lblPH_NO1s.Visible = lblFAX_NO1s.Visible = lblPINCODE_NO1s.Visible = lblPOST_OFFICE1s.Visible = lblEMAIL_ADDRESS1s.Visible = lblMOBILE_NUM1s.Visible = lblSEC_QUES1s.Visible = lblSEC_ANS1s.Visible = lblLOGIN_ID1s.Visible = lblPASSWORD1s.Visible = lblUSER_TYPE1s.Visible = lblREMARKS1s.Visible = lblAvtar1s.Visible = lblCompId1s.Visible = lblTill_DT1s.Visible = lblTill_DT1s.Visible = false;
          //1true
          txtFIRST_NAME1s.Visible = txtLAST_NAME1s.Visible = txtFIRST_NAME11s.Visible = txtLAST_NAME11s.Visible = txtFIRST_NAME21s.Visible = txtLAST_NAME21s.Visible = txtCOUNTRY1s.Visible = txtSTATE1s.Visible = txtPH_NO1s.Visible = txtFAX_NO1s.Visible = txtPINCODE_NO1s.Visible = txtPOST_OFFICE1s.Visible = txtEMAIL_ADDRESS1s.Visible = txtMOBILE_NUM1s.Visible = txtSEC_QUES1s.Visible = txtSEC_ANS1s.Visible = txtLOGIN_ID1s.Visible = txtPASSWORD1s.Visible = txtUSER_TYPE1s.Visible = txtREMARKS1s.Visible = txtAvtar1s.Visible = txtCompId1s.Visible = txtTill_DT1s.Visible = txtTill_DT1s.Visible = true;
          //header
          lblHeader.Visible = false;
          txtHeader.Visible = true;
          btnEditLable.Text = "Save Label";
        ...
        else
        {
          ...
          btnEditLable.Text = "Update Label";
          //1true
          lblFIRST_NAME1s.Visible = lblLAST_NAME1s.Visible = lblFIRST_NAME11s.Visible = lblLAST_NAME11s.Visible = lblFIRST_NAME21s.Visible = lblLAST_NAME21s.Visible = lblCOUNTRY1s.Visible = lblSTATE1s.Visible = lblPH_NO1s.Visible = lblFAX_NO1s.Visible = lblPINCODE_NO1s.Visible = lblPOST_OFFICE1s.Visible = lblEMAIL_ADDRESS1s.Visible = lblMOBILE_NUM1s.Visible = lblSEC_QUES1s.Visible = lblSEC_ANS1s.Visible = lblLOGIN_ID1s.Visible = lblPASSWORD1s.Visible = lblUSER_TYPE1s.Visible = lblREMARKS1s.Visible = lblAvtar1s.Visible = lblCompId1s.Visible = lblTill_DT1s.Visible = lblTill_DT1s.Visible = true;
          //1false
          txtFIRST_NAME1s.Visible = txtLAST_NAME1s.Visible = txtFIRST_NAME11s.Visible = txtLAST_NAME11s.Visible = txtFIRST_NAME21s.Visible = txtLAST_NAME21s.Visible = txtCOUNTRY1s.Visible = txtSTATE1s.Visible = txtPH_NO1s.Visible = txtFAX_NO1s.Visible = txtPINCODE_NO1s.Visible = txtPOST_OFFICE1s.Visible = txtEMAIL_ADDRESS1s.Visible = txtMOBILE_NUM1s.Visible = txtSEC_QUES1s.Visible = txtSEC_ANS1s.Visible = txtLOGIN_ID1s.Visible = txtPASSWORD1s.Visible = txtUSER_TYPE1s.Visible = txtREMARKS1s.Visible = txtAvtar1s.Visible = txtCompId1s.Visible = txtTill_DT1s.Visible = txtTill_DT1s.Visible = false;
          //header
          lblHeader.Visible = true;
          txtHeader.Visible = false;
        }
    ...
    protected void Listview1_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
      using (TransactionScope scope = new TransactionScope())
      {
        ...
        if (e.CommandName == "btnEdit")
        {
          ...
          Database.USER_MST objUSER_MST = DB.USER_MST.Single(p => p.USER_ID == str1 && p.TenentID == TID);
          drpTenentID.SelectedValue = objUSER_MST.TenentID.ToString();
          drpLoctionId.SelectedValue = objUSER_MST.LOCATION_ID.ToString();
          //   drpUSER_DETAIL_ID.SelectedValue = objUSER_MST.USER_DETAIL_ID.ToString();
          txtFIRST_NAME.Text = objUSER_MST.FIRST_NAME.ToString();
    ...
    protected void drpTenentID_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      //drpUSER_TYPE.DataSource = DB.ROLE_MST.Where(p => p.ACTIVE_FLAG == "Y" && p.TenentID == TID);
      //drpUSER_TYPE.DataTextField = "ROLE_NAME";
      //drpUSER_TYPE.DataValueField = "ROLE_ID";
    ...
    public void USerListBind(int Tenent, int Location)
    {
      ...
      using (SqlConnection conn = new SqlConnection(connectionString))
      using (SqlCommand cmd = new SqlCommand("usp_GetActiveUsers", conn))
      {
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@TenentID", Tenent);
      ...
      List<Database.USER_MST> List = DB.USER_MST.Where(p => p.ACTIVE_FLAG == "Y" && p.TenentID == Tenent && p.LOCATION_ID == Location && p.ACTIVEUSER == true && p.THEME_NAME == "YES").OrderBy(m => m.USER_ID).ToList();
