                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblFIRST_NAME1s" class="col-md-4 control-label" Text="First Name" ></asp:Label><asp:TextBox runat="server" ID="txtFIRST_NAME1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtFIRST_NAME" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFIRST_NAME" ErrorMessage="First Name Required." CssClass="Validation" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblLAST_NAME1s" class="col-md-4 control-label" Text="Last Name"></asp:Label><asp:TextBox runat="server" ID="txtLAST_NAME1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblFIRST_NAME11s" class="col-md-4 control-label" Text="First Name 1"></asp:Label><asp:TextBox runat="server" ID="txtFIRST_NAME11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblLAST_NAME11s" class="col-md-4 control-label" Text="Last Name 1"></asp:Label><asp:TextBox runat="server" ID="txtLAST_NAME11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblFIRST_NAME21s" class="col-md-4 control-label" Text="First Name 2"></asp:Label><asp:TextBox runat="server" ID="txtFIRST_NAME21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtFIRST_NAME2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblLAST_NAME21s" class="col-md-4 control-label" Text="Last Name 2"></asp:Label><asp:TextBox runat="server" ID="txtLAST_NAME21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtLAST_NAME2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                        ...
                                                        <asp:UpdatePanel ID="contry" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group" style="color: ">
                                                                            <asp:Label runat="server" ID="lblCOUNTRY1s" class="col-md-4 control-label" Text="Country"></asp:Label><asp:TextBox runat="server" ID="txtCOUNTRY1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                                <asp:DropDownList ID="drpCOUNTRY" OnSelectedIndexChanged="drpCOUNTRY_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group" style="color: ">
                                                                            <asp:Label runat="server" ID="lblSTATE1s" class="col-md-4 control-label" Text="State"></asp:Label><asp:TextBox runat="server" ID="txtSTATE1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                                <asp:DropDownList ID="drpSTATE" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPH_NO1s" class="col-md-4 control-label" Text="Phone No"></asp:Label><asp:TextBox runat="server" ID="txtPH_NO1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblFAX_NO1s" class="col-md-4 control-label" Text="Fax"></asp:Label><asp:TextBox runat="server" ID="txtFAX_NO1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPINCODE_NO1s" class="col-md-4 control-label" Text="Pin Code"></asp:Label><asp:TextBox runat="server" ID="txtPINCODE_NO1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPOST_OFFICE1s" class="col-md-4 control-label" Text="POST OFFICE"></asp:Label><asp:TextBox runat="server" ID="txtPOST_OFFICE1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblEMAIL_ADDRESS1s" class="col-md-4 control-label" Text="Email Address"></asp:Label><asp:TextBox runat="server" ID="txtEMAIL_ADDRESS1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMOBILE_NUM1s" class="col-md-4 control-label" Text="Mobile Number"></asp:Label><asp:TextBox runat="server" ID="txtMOBILE_NUM1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSEC_QUES1s" class="col-md-4 control-label" Text="Security Question"></asp:Label><asp:TextBox runat="server" ID="txtSEC_QUES1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpSEC_QUES" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSEC_QUES2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSEC_QUES2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSEC_ANS1s" class="col-md-4 control-label" Text="Answer"></asp:Label><asp:TextBox runat="server" ID="txtSEC_ANS1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtSEC_ANS" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSEC_ANS2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSEC_ANS2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblLOGIN_ID1s" class="col-md-4 control-label" Text="Login ID"></asp:Label><asp:TextBox runat="server" ID="txtLOGIN_ID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtLOGIN_ID" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLOGIN_ID" ErrorMessage="Login Name Required." CssClass="Validation" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPASSWORD1s" class="col-md-4 control-label" Text="Password"></asp:Label><asp:TextBox runat="server" ID="txtPASSWORD1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblUSER_TYPE1s" class="col-md-4 control-label" Text="User Type"></asp:Label><asp:TextBox runat="server" ID="txtUSER_TYPE1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpUSER_TYPE" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCompId1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCompId1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpCompId" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblCompId2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCompId2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtuserdate" CssClass="form-control" runat="server" placeholder="MM-dd-yy"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtuserdate" Format="MM-dd-yy" Enabled="True"></cc1:CalendarExtender>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtTill_DT" runat="server" CssClass="form-control" placeholder="MM-dd-yy"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtTill_DT" Format="MM-dd-yy" Enabled="True"></cc1:CalendarExtender>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:DropDownList ID="DrpDefaulrLang" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>                                                                    
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblREMARKS1s" class="col-md-2 control-label"></asp:Label><asp:TextBox runat="server" ID="txtREMARKS1s" class="col-md-2 control-label" Visible="false"></asp:TextBox><div class="col-md-10">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">btna
                                                              ...
                                                              <div class="col-md-6">
     <div class="form-group" >
         <asp:Label runat="server" ID="Label8" Text="Copy User" class="col-md-4 control-label"></asp:Label>
         <div class="col-md-8">
            <asp:DropDownList ID="drpusers" runat="server"  CssClass="form-control"></asp:DropDownList>
              <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="0" runat="server" ControlToValidate="drpUSER_TYPE" ErrorMessage="User Type Required." CssClass="Validation" ValidationGroup="s" ForeColor="Red"></asp:RequiredFieldValidator>--%>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="0" runat="server" ControlToValidate="drpusers" ErrorMessage="User Name Required." ValidationGroup="usergroup" CssClass="Validation"></asp:RequiredFieldValidator>
             </div>
