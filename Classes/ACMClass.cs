...
namespace Classes
{
    public static class ACMClass
    {
        ...
        public static bool RegisterUser(int UserID, int FromUserID, DateTime TillDate)
        {
           ...
           string connectionString = ConfigurationManager.ConnectionStrings["CRMNewEntitiesNew"].ConnectionString;
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("Register_User", conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ActiveTillDate", TillDate);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ApplicationException("Error inserting employee: " + ex.Message);
                    }
                }
            }
