...
namespace Classes
{
    public static class GlobleClass
    {
        ...
        public static class EncryptionHelpers
        {
            ...
            public static int WriteLog(string LogText, string MstText, string table, string UserID, int MeniID, int AuditNo)
            {
        ...
        public static void InsertErrorLog1(string tablename, string Pagename, string evantname,string LineNo)
        {
            ...
            if (HttpContext.Current != null)
            {
                ...
                GlobleClass.EncryptionHelpers.WriteLog(url, evantname, tablename, loginUserId.ToString(), 0,0);
            }
